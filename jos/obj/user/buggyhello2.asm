...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8000c5:	50                   	push   %eax
  8000c6:	52                   	push   %edx
  8000c7:	68 ac 0d 80 00       	push   $0x800dac
  8000cc:	6a 23                	push   $0x23
  8000ce:	68 c9 0d 80 00       	push   $0x800dc9
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80018c:	56                   	push   %esi
  80018d:	50                   	push   %eax
  80018e:	68 d8 0d 80 00       	push   $0x800dd8
  ...
  80019f:	e8 54 00 00 00       	call   8001f8 <vcprintf>
	cprintf("\n");
  8001a4:	c7 04 24 a0 0d 80 00 	movl   $0x800da0,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002ac:	e8 5f 08 00 00       	call   800b10 <__udivdi3>
  ...
  8002ef:	e8 4c 09 00 00       	call   800c40 <__umoddi3>
  8002f4:	83 c4 14             	add    $0x14,%esp
  8002f7:	0f be 80 fc 0d 80 00 	movsbl 0x800dfc(%eax),%eax
  8002fe:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800425:	ff 24 85 8c 0e 80 00 	jmp    *0x800e8c(,%eax,4)
  ...
  8004e9:	8b 14 85 e4 0f 80 00 	mov    0x800fe4(,%eax,4),%edx
  8004f0:	85 d2                	test   %edx,%edx
  8004f2:	75 18                	jne    80050c <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  8004f4:	50                   	push   %eax
  8004f5:	68 14 0e 80 00       	push   $0x800e14
  8004fa:	53                   	push   %ebx
  8004fb:	56                   	push   %esi
  ...
  80050c:	52                   	push   %edx
  80050d:	68 1d 0e 80 00       	push   $0x800e1d
  800512:	53                   	push   %ebx
  800513:	56                   	push   %esi
  ...
  800531:	b8 0d 0e 80 00       	mov    $0x800e0d,%eax
...
memfind(const void *s, int c, size_t n)
{
  ...
  800a0b:	03 4d 10             	add    0x10(%ebp),%ecx
	for (; s < ends; s++)
		if (*(const unsigned char *) s == (unsigned char) c)
  800a0e:	0f b6 5d 0c          	movzbl 0xc(%ebp),%ebx
...
memfind(const void *s, int c, size_t n)
{
	const void *ends = (const char *) s + n;
	for (; s < ends; s++)
  800a12:	eb 0a                	jmp    800a1e <memfind+0x1c>
		if (*(const unsigned char *) s == (unsigned char) c)
  800a14:	0f b6 10             	movzbl (%eax),%edx
  800a17:	39 da                	cmp    %ebx,%edx
  800a19:	74 07                	je     800a22 <memfind+0x20>
...
memfind(const void *s, int c, size_t n)
{
  ...
  800a1e:	39 c8                	cmp    %ecx,%eax
  800a20:	72 f2                	jb     800a14 <memfind+0x12>
		if (*(const unsigned char *) s == (unsigned char) c)
			break;
	return (void *) s;
}
...
strtol(const char *s, char **endptr, int base)
{
  ...
  800a2e:	8b 5d 10             	mov    0x10(%ebp),%ebx
	...
	while (*s == ' ' || *s == '\t')
  800a31:	eb 03                	jmp    800a36 <strtol+0x11>
		s++;
  800a33:	83 c1 01             	add    $0x1,%ecx
{
  ...
  800a3b:	74 f6                	je     800a33 <strtol+0xe>
  800a3d:	3c 09                	cmp    $0x9,%al
  800a3f:	74 f2                	je     800a33 <strtol+0xe>
		s++;

	// plus/minus sign
	if (*s == '+')
  800a41:	3c 2b                	cmp    $0x2b,%al
  800a43:	75 0a                	jne    800a4f <strtol+0x2a>
		s++;
...
strtol(const char *s, char **endptr, int base)
{
  ...
  800a4d:	eb 11                	jmp    800a60 <strtol+0x3b>
  ...
  800a56:	75 08                	jne    800a60 <strtol+0x3b>
		s++, neg = 1;
  ...
  800a66:	75 15                	jne    800a7d <strtol+0x58>
  800a68:	80 39 30             	cmpb   $0x30,(%ecx)
  800a6b:	75 10                	jne    800a7d <strtol+0x58>
  800a6d:	80 79 01 78          	cmpb   $0x78,0x1(%ecx)
  800a71:	75 7c                	jne    800aef <strtol+0xca>
		s += 2, base = 16;
  800a73:	83 c1 02             	add    $0x2,%ecx
  800a76:	bb 10 00 00 00       	mov    $0x10,%ebx
  800a7b:	eb 16                	jmp    800a93 <strtol+0x6e>
	else if (base == 0 && s[0] == '0')
  800a7d:	85 db                	test   %ebx,%ebx
  800a7f:	75 12                	jne    800a93 <strtol+0x6e>
		s++, base = 8;
	else if (base == 0)
		base = 10;
  800a81:	bb 0a 00 00 00       	mov    $0xa,%ebx
		s++, neg = 1;
  ...
  800a89:	75 08                	jne    800a93 <strtol+0x6e>
		s++, base = 8;
  800a8b:	83 c1 01             	add    $0x1,%ecx
  800a8e:	bb 08 00 00 00       	mov    $0x8,%ebx
	else if (base == 0)
		base = 10;
  ...
  800aa6:	77 08                	ja     800ab0 <strtol+0x8b>
			dig = *s - '0';
  800aa8:	0f be d2             	movsbl %dl,%edx
  800aab:	83 ea 30             	sub    $0x30,%edx
  800aae:	eb 22                	jmp    800ad2 <strtol+0xad>
		else if (*s >= 'a' && *s <= 'z')
  800ab0:	8d 72 9f             	lea    -0x61(%edx),%esi
  800ab3:	89 f3                	mov    %esi,%ebx
  800ab5:	80 fb 19             	cmp    $0x19,%bl
  800ab8:	77 08                	ja     800ac2 <strtol+0x9d>
			dig = *s - 'a' + 10;
  800aba:	0f be d2             	movsbl %dl,%edx
  800abd:	83 ea 57             	sub    $0x57,%edx
  800ac0:	eb 10                	jmp    800ad2 <strtol+0xad>
		else if (*s >= 'A' && *s <= 'Z')
  800ac2:	8d 72 bf             	lea    -0x41(%edx),%esi
  800ac5:	89 f3                	mov    %esi,%ebx
  800ac7:	80 fb 19             	cmp    $0x19,%bl
  800aca:	77 16                	ja     800ae2 <strtol+0xbd>
			dig = *s - 'A' + 10;
  800acc:	0f be d2             	movsbl %dl,%edx
  800acf:	83 ea 37             	sub    $0x37,%edx
		else
			break;
		if (dig >= base)
  800ad2:	3b 55 10             	cmp    0x10(%ebp),%edx
  800ad5:	7d 0b                	jge    800ae2 <strtol+0xbd>
			break;
		s++, val = (val * base) + dig;
  800ad7:	83 c1 01             	add    $0x1,%ecx
  800ada:	0f af 45 10          	imul   0x10(%ebp),%eax
  800ade:	01 d0                	add    %edx,%eax
		// we don't properly detect overflow!
	}
  800ae0:	eb b9                	jmp    800a9b <strtol+0x76>

	if (endptr)
  800ae2:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
  800ae6:	74 0d                	je     800af5 <strtol+0xd0>
		*endptr = (char *) s;
  800ae8:	8b 75 0c             	mov    0xc(%ebp),%esi
  800aeb:	89 0e                	mov    %ecx,(%esi)
  800aed:	eb 06                	jmp    800af5 <strtol+0xd0>
		s++, neg = 1;
  ...
  800af1:	74 98                	je     800a8b <strtol+0x66>
  800af3:	eb 9e                	jmp    800a93 <strtol+0x6e>
		// we don't properly detect overflow!
	}
