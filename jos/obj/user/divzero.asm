...
umain(int argc, char **argv)
{
  ...
  800050:	50                   	push   %eax
  800051:	68 a4 0d 80 00       	push   $0x800da4
...
exit(void)
{
  ...
  80009e:	e8 e6 09 00 00       	call   800a89 <sys_env_destroy>
}
...
putch(int ch, struct printbuf *b)
{
  ...
  8000d2:	50                   	push   %eax
  8000d3:	e8 67 09 00 00       	call   800a3f <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80012d:	50                   	push   %eax
  80012e:	e8 0c 09 00 00       	call   800a3f <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80019e:	e8 7d 09 00 00       	call   800b20 <__udivdi3>
  ...
  8001e1:	e8 6a 0a 00 00       	call   800c50 <__umoddi3>
  8001e6:	83 c4 14             	add    $0x14,%esp
  8001e9:	0f be 80 bc 0d 80 00 	movsbl 0x800dbc(%eax),%eax
  8001f0:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800317:	ff 24 85 4c 0e 80 00 	jmp    *0x800e4c(,%eax,4)
  ...
  8003db:	8b 14 85 a4 0f 80 00 	mov    0x800fa4(,%eax,4),%edx
  8003e2:	85 d2                	test   %edx,%edx
  8003e4:	75 18                	jne    8003fe <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  8003e6:	50                   	push   %eax
  8003e7:	68 d4 0d 80 00       	push   $0x800dd4
  8003ec:	53                   	push   %ebx
  8003ed:	56                   	push   %esi
  ...
  8003fe:	52                   	push   %edx
  8003ff:	68 dd 0d 80 00       	push   $0x800ddd
  800404:	53                   	push   %ebx
  800405:	56                   	push   %esi
  ...
  800423:	b8 cd 0d 80 00       	mov    $0x800dcd,%eax
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8009f9:	56                   	push   %esi
  8009fa:	53                   	push   %ebx
  8009fb:	83 ec 1c             	sub    $0x1c,%esp
  8009fe:	89 45 e0             	mov    %eax,-0x20(%ebp)
  800a01:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  ...
  800a0f:	8b 75 14             	mov    0x14(%ebp),%esi
  ...
  800a18:	74 1d                	je     800a37 <syscall+0x42>
  800a1a:	85 c0                	test   %eax,%eax
  800a1c:	7e 19                	jle    800a37 <syscall+0x42>
  800a1e:	8b 55 e0             	mov    -0x20(%ebp),%edx
		panic("syscall %d returned %d (> 0)", num, ret);
  800a21:	83 ec 0c             	sub    $0xc,%esp
  800a24:	50                   	push   %eax
  800a25:	52                   	push   %edx
  800a26:	68 c0 0f 80 00       	push   $0x800fc0
  800a2b:	6a 23                	push   $0x23
  800a2d:	68 dd 0f 80 00       	push   $0x800fdd
  800a32:	e8 98 00 00 00       	call   800acf <_panic>
...
sys_cputs(const char *s, size_t len)
{
  ...
  800a5b:	e8 95 ff ff ff       	call   8009f5 <syscall>
}
...
sys_cgetc(void)
{
  ...
  800a82:	e8 6e ff ff ff       	call   8009f5 <syscall>
}
  800a87:	c9                   	leave  
  800a88:	c3                   	ret    
...
sys_env_destroy(envid_t envid)
{
  ...
  800a9a:	ba 01 00 00 00       	mov    $0x1,%edx
  800a9f:	b8 03 00 00 00       	mov    $0x3,%eax
  800aa4:	e8 4c ff ff ff       	call   8009f5 <syscall>
}
  800aa9:	c9                   	leave  
  800aaa:	c3                   	ret    
...
sys_getenvid(void)
{
  ...
  800ac8:	e8 28 ff ff ff       	call   8009f5 <syscall>
}
  800acd:	c9                   	leave  
  800ace:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800ad3:	53                   	push   %ebx
	...
	va_start(ap, fmt);
  800ad4:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800ad7:	8b 35 00 20 80 00    	mov    0x802000,%esi
  ...
  800aeb:	56                   	push   %esi
  800aec:	50                   	push   %eax
  800aed:	68 ec 0f 80 00       	push   $0x800fec
  800af2:	e8 44 f6 ff ff       	call   80013b <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800af7:	83 c4 18             	add    $0x18,%esp
  800afa:	53                   	push   %ebx
  800afb:	ff 75 10             	pushl  0x10(%ebp)
  800afe:	e8 e7 f5 ff ff       	call   8000ea <vcprintf>
	cprintf("\n");
  800b03:	c7 04 24 b0 0d 80 00 	movl   $0x800db0,(%esp)
  800b0a:	e8 2c f6 ff ff       	call   80013b <cprintf>
  800b0f:	83 c4 10             	add    $0x10,%esp
	...
	while (1)
		asm volatile("int3");
  800b12:	cc                   	int3   
  800b13:	eb fd                	jmp    800b12 <_panic+0x43>
