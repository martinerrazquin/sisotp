...
umain(int argc, char **argv)
{
  ...
  800043:	e8 5e 0a 00 00       	call   800aa6 <sys_getenvid>
...
exit(void)
{
  ...
  800099:	e8 e6 09 00 00       	call   800a84 <sys_env_destroy>
}
...
putch(int ch, struct printbuf *b)
{
  ...
  8000cd:	50                   	push   %eax
  8000ce:	e8 67 09 00 00       	call   800a3a <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800128:	50                   	push   %eax
  800129:	e8 0c 09 00 00       	call   800a3a <sys_cputs>
...
memfind(const void *s, int c, size_t n)
{
  ...
  8008f6:	89 c1                	mov    %eax,%ecx
  8008f8:	03 4d 10             	add    0x10(%ebp),%ecx
	for (; s < ends; s++)
...
memfind(const void *s, int c, size_t n)
{
	const void *ends = (const char *) s + n;
	for (; s < ends; s++)
  8008ff:	eb 0a                	jmp    80090b <memfind+0x1c>
		if (*(const unsigned char *) s == (unsigned char) c)
  800901:	0f b6 10             	movzbl (%eax),%edx
  800904:	39 da                	cmp    %ebx,%edx
  800906:	74 07                	je     80090f <memfind+0x20>
...
memfind(const void *s, int c, size_t n)
{
  ...
  80090d:	72 f2                	jb     800901 <memfind+0x12>
		if (*(const unsigned char *) s == (unsigned char) c)
			break;
	return (void *) s;
}
  ...
  800920:	83 c1 01             	add    $0x1,%ecx
{
  ...
  800930:	75 0a                	jne    80093c <strtol+0x2a>
		s++;
...
strtol(const char *s, char **endptr, int base)
{
  ...
  80093a:	eb 11                	jmp    80094d <strtol+0x3b>
  ...
  800941:	3c 2d                	cmp    $0x2d,%al
  800943:	75 08                	jne    80094d <strtol+0x3b>
		s++, neg = 1;
  800945:	83 c1 01             	add    $0x1,%ecx
  800948:	bf 01 00 00 00       	mov    $0x1,%edi

	// hex or octal base prefix
	if ((base == 0 || base == 16) && (s[0] == '0' && s[1] == 'x'))
  80094d:	f7 c3 ef ff ff ff    	test   $0xffffffef,%ebx
  800953:	75 15                	jne    80096a <strtol+0x58>
  800955:	80 39 30             	cmpb   $0x30,(%ecx)
  800958:	75 10                	jne    80096a <strtol+0x58>
  80095a:	80 79 01 78          	cmpb   $0x78,0x1(%ecx)
  80095e:	75 7c                	jne    8009dc <strtol+0xca>
		s += 2, base = 16;
  800960:	83 c1 02             	add    $0x2,%ecx
  800963:	bb 10 00 00 00       	mov    $0x10,%ebx
  800968:	eb 16                	jmp    800980 <strtol+0x6e>
	else if (base == 0 && s[0] == '0')
  80096a:	85 db                	test   %ebx,%ebx
  80096c:	75 12                	jne    800980 <strtol+0x6e>
		s++, base = 8;
	else if (base == 0)
		base = 10;
  ...
  800976:	75 08                	jne    800980 <strtol+0x6e>
		s++, base = 8;
  800978:	83 c1 01             	add    $0x1,%ecx
  80097b:	bb 08 00 00 00       	mov    $0x8,%ebx
	else if (base == 0)
		base = 10;
  ...
  800985:	89 5d 10             	mov    %ebx,0x10(%ebp)
	...
	while (1) {
		...
		if (*s >= '0' && *s <= '9')
  800988:	0f b6 11             	movzbl (%ecx),%edx
  80098b:	8d 72 d0             	lea    -0x30(%edx),%esi
  80098e:	89 f3                	mov    %esi,%ebx
  800990:	80 fb 09             	cmp    $0x9,%bl
  800993:	77 08                	ja     80099d <strtol+0x8b>
			dig = *s - '0';
  800995:	0f be d2             	movsbl %dl,%edx
  800998:	83 ea 30             	sub    $0x30,%edx
  80099b:	eb 22                	jmp    8009bf <strtol+0xad>
		else if (*s >= 'a' && *s <= 'z')
  80099d:	8d 72 9f             	lea    -0x61(%edx),%esi
  8009a0:	89 f3                	mov    %esi,%ebx
  8009a2:	80 fb 19             	cmp    $0x19,%bl
  8009a5:	77 08                	ja     8009af <strtol+0x9d>
			dig = *s - 'a' + 10;
  8009a7:	0f be d2             	movsbl %dl,%edx
  8009aa:	83 ea 57             	sub    $0x57,%edx
  8009ad:	eb 10                	jmp    8009bf <strtol+0xad>
		else if (*s >= 'A' && *s <= 'Z')
  8009af:	8d 72 bf             	lea    -0x41(%edx),%esi
  8009b2:	89 f3                	mov    %esi,%ebx
  8009b4:	80 fb 19             	cmp    $0x19,%bl
  8009b7:	77 16                	ja     8009cf <strtol+0xbd>
			dig = *s - 'A' + 10;
  8009b9:	0f be d2             	movsbl %dl,%edx
  8009bc:	83 ea 37             	sub    $0x37,%edx
		else
			break;
		if (dig >= base)
  8009bf:	3b 55 10             	cmp    0x10(%ebp),%edx
  8009c2:	7d 0b                	jge    8009cf <strtol+0xbd>
			break;
		s++, val = (val * base) + dig;
  ...
  8009cd:	eb b9                	jmp    800988 <strtol+0x76>

	if (endptr)
  8009cf:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
  8009d3:	74 0d                	je     8009e2 <strtol+0xd0>
		*endptr = (char *) s;
  8009d5:	8b 75 0c             	mov    0xc(%ebp),%esi
  8009d8:	89 0e                	mov    %ecx,(%esi)
  8009da:	eb 06                	jmp    8009e2 <strtol+0xd0>
		s++, neg = 1;
  ...
  8009de:	74 98                	je     800978 <strtol+0x66>
  8009e0:	eb 9e                	jmp    800980 <strtol+0x6e>
		// we don't properly detect overflow!
	}
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800a13:	74 1d                	je     800a32 <syscall+0x42>
  800a15:	85 c0                	test   %eax,%eax
  800a17:	7e 19                	jle    800a32 <syscall+0x42>
  800a19:	8b 55 e0             	mov    -0x20(%ebp),%edx
		panic("syscall %d returned %d (> 0)", num, ret);
  800a1c:	83 ec 0c             	sub    $0xc,%esp
  800a1f:	50                   	push   %eax
  800a20:	52                   	push   %edx
  800a21:	68 c4 0f 80 00       	push   $0x800fc4
  800a26:	6a 23                	push   $0x23
  800a28:	68 e1 0f 80 00       	push   $0x800fe1
  800a2d:	e8 98 00 00 00       	call   800aca <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800ad2:	8b 35 00 20 80 00    	mov    0x802000,%esi
  800ad8:	e8 c9 ff ff ff       	call   800aa6 <sys_getenvid>
  800add:	83 ec 0c             	sub    $0xc,%esp
  800ae0:	ff 75 0c             	pushl  0xc(%ebp)
  800ae3:	ff 75 08             	pushl  0x8(%ebp)
  800ae6:	56                   	push   %esi
  800ae7:	50                   	push   %eax
  800ae8:	68 f0 0f 80 00       	push   $0x800ff0
  800aed:	e8 44 f6 ff ff       	call   800136 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800af2:	83 c4 18             	add    $0x18,%esp
  800af5:	53                   	push   %ebx
  800af6:	ff 75 10             	pushl  0x10(%ebp)
  800af9:	e8 e7 f5 ff ff       	call   8000e5 <vcprintf>
	cprintf("\n");
  800afe:	c7 04 24 a0 0d 80 00 	movl   $0x800da0,(%esp)
  800b05:	e8 2c f6 ff ff       	call   800136 <cprintf>
  800b0a:	83 c4 10             	add    $0x10,%esp
	...
	while (1)
		asm volatile("int3");
  800b0d:	cc                   	int3   
  800b0e:	eb fd                	jmp    800b0d <_panic+0x43>
