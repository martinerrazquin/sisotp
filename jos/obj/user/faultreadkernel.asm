	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001eb:	0f be 80 11 0f 80 00 	movsbl 0x800f11(%eax),%eax
  8001f2:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800319:	ff 24 85 e0 0f 80 00 	jmp    *0x800fe0(,%eax,4)
  ...
  8003dd:	8b 14 85 40 11 80 00 	mov    0x801140(,%eax,4),%edx
  8003e4:	85 d2                	test   %edx,%edx
  8003e6:	75 18                	jne    800400 <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  8003e8:	50                   	push   %eax
  8003e9:	68 29 0f 80 00       	push   $0x800f29
  8003ee:	53                   	push   %ebx
  8003ef:	56                   	push   %esi
  ...
  800400:	52                   	push   %edx
  800401:	68 32 0f 80 00       	push   $0x800f32
  800406:	53                   	push   %ebx
  800407:	56                   	push   %esi
  ...
  800425:	b8 22 0f 80 00       	mov    $0x800f22,%eax
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800a20:	50                   	push   %eax
  800a21:	52                   	push   %edx
  800a22:	68 64 11 80 00       	push   $0x801164
  800a27:	6a 23                	push   $0x23
  800a29:	68 81 11 80 00       	push   $0x801181
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800c08:	56                   	push   %esi
  800c09:	50                   	push   %eax
  800c0a:	68 90 11 80 00       	push   $0x801190
  ...
  800c1b:	e8 cc f4 ff ff       	call   8000ec <vcprintf>
	cprintf("\n");
  800c20:	c7 04 24 b4 11 80 00 	movl   $0x8011b4,(%esp)
