	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001d7:	0f be 80 ac 0d 80 00 	movsbl 0x800dac(%eax),%eax
  8001de:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800305:	ff 24 85 3c 0e 80 00 	jmp    *0x800e3c(,%eax,4)
  ...
  8003c9:	8b 14 85 94 0f 80 00 	mov    0x800f94(,%eax,4),%edx
  8003d0:	85 d2                	test   %edx,%edx
  8003d2:	75 18                	jne    8003ec <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  8003d4:	50                   	push   %eax
  8003d5:	68 c4 0d 80 00       	push   $0x800dc4
  8003da:	53                   	push   %ebx
  8003db:	56                   	push   %esi
  ...
  8003ec:	52                   	push   %edx
  8003ed:	68 cd 0d 80 00       	push   $0x800dcd
  8003f2:	53                   	push   %ebx
  8003f3:	56                   	push   %esi
  ...
  800411:	b8 bd 0d 80 00       	mov    $0x800dbd,%eax
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800a0c:	50                   	push   %eax
  800a0d:	52                   	push   %edx
  800a0e:	68 b0 0f 80 00       	push   $0x800fb0
  800a13:	6a 23                	push   $0x23
  800a15:	68 cd 0f 80 00       	push   $0x800fcd
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800ad3:	56                   	push   %esi
  800ad4:	50                   	push   %eax
  800ad5:	68 dc 0f 80 00       	push   $0x800fdc
  ...
  800ae6:	e8 ed f5 ff ff       	call   8000d8 <vcprintf>
	cprintf("\n");
  800aeb:	c7 04 24 a0 0d 80 00 	movl   $0x800da0,(%esp)
