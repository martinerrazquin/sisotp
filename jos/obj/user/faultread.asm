	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800238:	0f be 80 dc 0e 80 00 	movsbl 0x800edc(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800385:	ff 24 8d 6c 0f 80 00 	jmp    *0x800f6c(,%ecx,4)
  ...
  800451:	c7 44 24 08 fd 0e 80 	movl   $0x800efd,0x8(%esp)
  800458:	00 
  ...
  800483:	b8 ed 0e 80 00       	mov    $0x800eed,%eax
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800acb:	c7 44 24 08 e0 10 80 	movl   $0x8010e0,0x8(%esp)
  800ad2:	00 
  800ad3:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ada:	00 
  800adb:	c7 04 24 fd 10 80 00 	movl   $0x8010fd,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800c02:	c7 04 24 0c 11 80 00 	movl   $0x80110c,(%esp)
  ...
  800c18:	e8 bc f4 ff ff       	call   8000d9 <vcprintf>
	cprintf("\n");
  800c1d:	c7 04 24 d0 0e 80 00 	movl   $0x800ed0,(%esp)
