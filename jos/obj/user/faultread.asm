	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001d7:	0f be 80 bc 0d 80 00 	movsbl 0x800dbc(%eax),%eax
  8001de:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800305:	ff 24 85 4c 0e 80 00 	jmp    *0x800e4c(,%eax,4)
  ...
  8003c9:	8b 14 85 a4 0f 80 00 	mov    0x800fa4(,%eax,4),%edx
  8003d0:	85 d2                	test   %edx,%edx
  8003d2:	75 18                	jne    8003ec <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  8003d4:	50                   	push   %eax
  8003d5:	68 d4 0d 80 00       	push   $0x800dd4
  8003da:	53                   	push   %ebx
  8003db:	56                   	push   %esi
  ...
  8003ec:	52                   	push   %edx
  8003ed:	68 dd 0d 80 00       	push   $0x800ddd
  8003f2:	53                   	push   %ebx
  8003f3:	56                   	push   %esi
  ...
  800411:	b8 cd 0d 80 00       	mov    $0x800dcd,%eax
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800a12:	50                   	push   %eax
  800a13:	52                   	push   %edx
  800a14:	68 c0 0f 80 00       	push   $0x800fc0
  800a19:	6a 23                	push   $0x23
  800a1b:	68 dd 0f 80 00       	push   $0x800fdd
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800ad9:	56                   	push   %esi
  800ada:	50                   	push   %eax
  800adb:	68 ec 0f 80 00       	push   $0x800fec
  ...
  800aec:	e8 e7 f5 ff ff       	call   8000d8 <vcprintf>
	cprintf("\n");
  800af1:	c7 04 24 b0 0d 80 00 	movl   $0x800db0,(%esp)
