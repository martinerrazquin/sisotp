...
exit(void)
{
  ...
  800080:	e8 cd 00 00 00       	call   800152 <sys_env_destroy>
}
  800085:	c9                   	leave  
  800086:	c3                   	ret    
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  80008b:	56                   	push   %esi
  80008c:	53                   	push   %ebx
  80008d:	83 ec 2c             	sub    $0x2c,%esp
  800090:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  800093:	89 55 e0             	mov    %edx,-0x20(%ebp)
  800096:	89 ca                	mov    %ecx,%edx
	//
  ...
  80009e:	8b 7d 10             	mov    0x10(%ebp),%edi
  8000a1:	8b 75 14             	mov    0x14(%ebp),%esi
  ...
  8000a8:	7e 2d                	jle    8000d7 <syscall+0x50>
  8000aa:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
  8000ae:	74 27                	je     8000d7 <syscall+0x50>
		panic("syscall %d returned %d (> 0)", num, ret);
  8000b0:	89 44 24 10          	mov    %eax,0x10(%esp)
  8000b4:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8000b7:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8000bb:	c7 44 24 08 b2 0e 80 	movl   $0x800eb2,0x8(%esp)
  8000c2:	00 
  8000c3:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8000ca:	00 
  8000cb:	c7 04 24 cf 0e 80 00 	movl   $0x800ecf,(%esp)
  8000d2:	e8 ef 00 00 00       	call   8001c6 <_panic>

	return ret;
}
  8000d7:	83 c4 2c             	add    $0x2c,%esp
  8000da:	5b                   	pop    %ebx
  8000db:	5e                   	pop    %esi
  8000dc:	5f                   	pop    %edi
  8000dd:	5d                   	pop    %ebp
...
sys_cputs(const char *s, size_t len)
{
  ...
  8000e5:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
  8000ec:	00 
  8000ed:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  8000f4:	00 
  8000f5:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  8000fc:	00 
  ...
  800110:	e8 72 ff ff ff       	call   800087 <syscall>
}
  800115:	c9                   	leave  
  800116:	c3                   	ret    
...
sys_cgetc(void)
{
  ...
  80011a:	83 ec 18             	sub    $0x18,%esp
	return syscall(SYS_cgetc, 0, 0, 0, 0, 0, 0);
  80011d:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
  800124:	00 
  800125:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  80012c:	00 
  ...
  80014b:	e8 37 ff ff ff       	call   800087 <syscall>
}
  800150:	c9                   	leave  
  800151:	c3                   	ret    
...
sys_env_destroy(envid_t envid)
{
  ...
  800158:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
  80015f:	00 
  800160:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  800167:	00 
  800168:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  80016f:	00 
  800170:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  800177:	8b 4d 08             	mov    0x8(%ebp),%ecx
  80017a:	ba 01 00 00 00       	mov    $0x1,%edx
  80017f:	b8 03 00 00 00       	mov    $0x3,%eax
  800184:	e8 fe fe ff ff       	call   800087 <syscall>
}
  800189:	c9                   	leave  
  80018a:	c3                   	ret    
...
sys_getenvid(void)
{
  ...
  800191:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
  800198:	00 
  800199:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  8001a0:	00 
  8001a1:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  8001a8:	00 
  8001a9:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8001b0:	b9 00 00 00 00       	mov    $0x0,%ecx
  8001b5:	ba 00 00 00 00       	mov    $0x0,%edx
  8001ba:	b8 02 00 00 00       	mov    $0x2,%eax
  8001bf:	e8 c3 fe ff ff       	call   800087 <syscall>
}
  8001c4:	c9                   	leave  
  8001c5:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8001d1:	8b 35 00 20 80 00    	mov    0x802000,%esi
  8001d7:	e8 af ff ff ff       	call   80018b <sys_getenvid>
  ...
  8001f2:	c7 04 24 e0 0e 80 00 	movl   $0x800ee0,(%esp)
  ...
  800208:	e8 51 00 00 00       	call   80025e <vcprintf>
	cprintf("\n");
  80020d:	c7 04 24 04 0f 80 00 	movl   $0x800f04,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  800249:	e8 91 fe ff ff       	call   8000df <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80029a:	e8 e1 01 00 00       	call   800480 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  8002b2:	e8 28 fe ff ff       	call   8000df <sys_cputs>
