...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8000b5:	50                   	push   %eax
  8000b6:	52                   	push   %edx
  8000b7:	68 7e 0d 80 00       	push   $0x800d7e
  8000bc:	6a 23                	push   $0x23
  8000be:	68 9b 0d 80 00       	push   $0x800d9b
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80017c:	56                   	push   %esi
  80017d:	50                   	push   %eax
  80017e:	68 ac 0d 80 00       	push   $0x800dac
  ...
  80018f:	e8 54 00 00 00       	call   8001e8 <vcprintf>
	cprintf("\n");
  800194:	c7 04 24 d0 0d 80 00 	movl   $0x800dd0,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80029c:	e8 4f 08 00 00       	call   800af0 <__udivdi3>
  ...
  8002df:	e8 3c 09 00 00       	call   800c20 <__umoddi3>
  8002e4:	83 c4 14             	add    $0x14,%esp
  8002e7:	0f be 80 d2 0d 80 00 	movsbl 0x800dd2(%eax),%eax
  8002ee:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800415:	ff 24 85 60 0e 80 00 	jmp    *0x800e60(,%eax,4)
  ...
  8004d9:	8b 14 85 b8 0f 80 00 	mov    0x800fb8(,%eax,4),%edx
  8004e0:	85 d2                	test   %edx,%edx
  8004e2:	75 18                	jne    8004fc <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  8004e4:	50                   	push   %eax
  8004e5:	68 ea 0d 80 00       	push   $0x800dea
  8004ea:	53                   	push   %ebx
  8004eb:	56                   	push   %esi
  ...
  8004fc:	52                   	push   %edx
  8004fd:	68 f3 0d 80 00       	push   $0x800df3
  800502:	53                   	push   %ebx
  800503:	56                   	push   %esi
  ...
  800521:	b8 e3 0d 80 00       	mov    $0x800de3,%eax
