...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8000bb:	c7 44 24 08 ae 0e 80 	movl   $0x800eae,0x8(%esp)
  8000c2:	00 
  8000c3:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8000ca:	00 
  8000cb:	c7 04 24 cb 0e 80 00 	movl   $0x800ecb,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8001f2:	c7 04 24 dc 0e 80 00 	movl   $0x800edc,(%esp)
  ...
  800208:	e8 51 00 00 00       	call   80025e <vcprintf>
	cprintf("\n");
  80020d:	c7 04 24 00 0f 80 00 	movl   $0x800f00,(%esp)
