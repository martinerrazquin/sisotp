...
memfind(const void *s, int c, size_t n)
{
  ...
  8009f9:	03 55 10             	add    0x10(%ebp),%edx
	for (; s < ends; s++)
  8009fc:	eb 07                	jmp    800a05 <memfind+0x17>
		if (*(const unsigned char *) s == (unsigned char) c)
  8009fe:	38 08                	cmp    %cl,(%eax)
  800a00:	74 07                	je     800a09 <memfind+0x1b>
...
memfind(const void *s, int c, size_t n)
{
  ...
  800a07:	72 f5                	jb     8009fe <memfind+0x10>
		if (*(const unsigned char *) s == (unsigned char) c)
			break;
	return (void *) s;
}
  ...
  800a19:	83 c1 01             	add    $0x1,%ecx
{
  ...
  800a29:	75 0a                	jne    800a35 <strtol+0x2a>
		s++;
...
strtol(const char *s, char **endptr, int base)
{
  ...
  800a33:	eb 11                	jmp    800a46 <strtol+0x3b>
  ...
  800a3c:	75 08                	jne    800a46 <strtol+0x3b>
		s++, neg = 1;
  800a3e:	83 c1 01             	add    $0x1,%ecx
  800a41:	bf 01 00 00 00       	mov    $0x1,%edi

	// hex or octal base prefix
	if ((base == 0 || base == 16) && (s[0] == '0' && s[1] == 'x'))
  800a46:	f7 c3 ef ff ff ff    	test   $0xffffffef,%ebx
  800a4c:	75 15                	jne    800a63 <strtol+0x58>
  800a4e:	80 39 30             	cmpb   $0x30,(%ecx)
  800a51:	75 10                	jne    800a63 <strtol+0x58>
  800a53:	80 79 01 78          	cmpb   $0x78,0x1(%ecx)
  800a57:	75 7c                	jne    800ad5 <strtol+0xca>
		s += 2, base = 16;
  800a59:	83 c1 02             	add    $0x2,%ecx
  800a5c:	bb 10 00 00 00       	mov    $0x10,%ebx
  800a61:	eb 16                	jmp    800a79 <strtol+0x6e>
	else if (base == 0 && s[0] == '0')
  800a63:	85 db                	test   %ebx,%ebx
  800a65:	75 12                	jne    800a79 <strtol+0x6e>
		s++, base = 8;
	else if (base == 0)
		base = 10;
  ...
  800a6f:	75 08                	jne    800a79 <strtol+0x6e>
		s++, base = 8;
  ...
  800abb:	7d 0b                	jge    800ac8 <strtol+0xbd>
			break;
		s++, val = (val * base) + dig;
  ...
  800ac6:	eb b9                	jmp    800a81 <strtol+0x76>

	if (endptr)
  800ac8:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
  800acc:	74 0d                	je     800adb <strtol+0xd0>
		*endptr = (char *) s;
  800ace:	8b 75 0c             	mov    0xc(%ebp),%esi
  800ad1:	89 0e                	mov    %ecx,(%esi)
  800ad3:	eb 06                	jmp    800adb <strtol+0xd0>
		s++, neg = 1;
  ...
  800ad7:	74 98                	je     800a71 <strtol+0x66>
  800ad9:	eb 9e                	jmp    800a79 <strtol+0x6e>
		// we don't properly detect overflow!
	}
