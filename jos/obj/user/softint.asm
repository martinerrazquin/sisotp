...
exit(void)
{
  ...
  80007c:	e8 cd 00 00 00       	call   80014e <sys_env_destroy>
}
  800081:	c9                   	leave  
  800082:	c3                   	ret    
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800087:	56                   	push   %esi
  800088:	53                   	push   %ebx
  800089:	83 ec 2c             	sub    $0x2c,%esp
  80008c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  80008f:	89 55 e0             	mov    %edx,-0x20(%ebp)
  800092:	89 ca                	mov    %ecx,%edx
	//
	...
	asm volatile("int %1\n"
  800094:	8b 4d 08             	mov    0x8(%ebp),%ecx
  800097:	8b 5d 0c             	mov    0xc(%ebp),%ebx
  80009a:	8b 7d 10             	mov    0x10(%ebp),%edi
  80009d:	8b 75 14             	mov    0x14(%ebp),%esi
  ...
  8000a4:	7e 2d                	jle    8000d3 <syscall+0x50>
  8000a6:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
  8000aa:	74 27                	je     8000d3 <syscall+0x50>
		panic("syscall %d returned %d (> 0)", num, ret);
  8000ac:	89 44 24 10          	mov    %eax,0x10(%esp)
  8000b0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8000b3:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8000b7:	c7 44 24 08 b2 0e 80 	movl   $0x800eb2,0x8(%esp)
  8000be:	00 
  8000bf:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8000c6:	00 
  8000c7:	c7 04 24 cf 0e 80 00 	movl   $0x800ecf,(%esp)
  8000ce:	e8 ef 00 00 00       	call   8001c2 <_panic>

	return ret;
}
  8000d3:	83 c4 2c             	add    $0x2c,%esp
  8000d6:	5b                   	pop    %ebx
  8000d7:	5e                   	pop    %esi
  8000d8:	5f                   	pop    %edi
  8000d9:	5d                   	pop    %ebp
...
sys_cputs(const char *s, size_t len)
{
  ...
  8000e1:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
  8000e8:	00 
  8000e9:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  8000f0:	00 
  8000f1:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  8000f8:	00 
  ...
  80010c:	e8 72 ff ff ff       	call   800083 <syscall>
}
  800111:	c9                   	leave  
  800112:	c3                   	ret    
...
sys_cgetc(void)
{
  ...
  800119:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
  800120:	00 
  800121:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  800128:	00 
  ...
  800142:	b8 01 00 00 00       	mov    $0x1,%eax
  800147:	e8 37 ff ff ff       	call   800083 <syscall>
}
  80014c:	c9                   	leave  
  80014d:	c3                   	ret    

0080014e <sys_env_destroy>:
...
sys_env_destroy(envid_t envid)
{
  ...
  800154:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
  80015b:	00 
  80015c:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  800163:	00 
  800164:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  80016b:	00 
  80016c:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  800173:	8b 4d 08             	mov    0x8(%ebp),%ecx
  800176:	ba 01 00 00 00       	mov    $0x1,%edx
  80017b:	b8 03 00 00 00       	mov    $0x3,%eax
  800180:	e8 fe fe ff ff       	call   800083 <syscall>
}
  800185:	c9                   	leave  
  800186:	c3                   	ret    

00800187 <sys_getenvid>:
...
sys_getenvid(void)
{
  ...
  80018a:	83 ec 18             	sub    $0x18,%esp
	 return syscall(SYS_getenvid, 0, 0, 0, 0, 0, 0);
  80018d:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
  800194:	00 
  800195:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  80019c:	00 
  80019d:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  8001a4:	00 
  ...
  8001bb:	e8 c3 fe ff ff       	call   800083 <syscall>
}
  8001c0:	c9                   	leave  
  8001c1:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8001d3:	e8 af ff ff ff       	call   800187 <sys_getenvid>
  8001d8:	8b 55 0c             	mov    0xc(%ebp),%edx
  8001db:	89 54 24 10          	mov    %edx,0x10(%esp)
  8001df:	8b 55 08             	mov    0x8(%ebp),%edx
  8001e2:	89 54 24 0c          	mov    %edx,0xc(%esp)
  8001e6:	89 74 24 08          	mov    %esi,0x8(%esp)
  8001ea:	89 44 24 04          	mov    %eax,0x4(%esp)
  8001ee:	c7 04 24 e0 0e 80 00 	movl   $0x800ee0,(%esp)
  8001f5:	e8 c1 00 00 00       	call   8002bb <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  8001fa:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  8001fe:	8b 45 10             	mov    0x10(%ebp),%eax
  800201:	89 04 24             	mov    %eax,(%esp)
  800204:	e8 51 00 00 00       	call   80025a <vcprintf>
	cprintf("\n");
  800209:	c7 04 24 04 0f 80 00 	movl   $0x800f04,(%esp)
  800210:	e8 a6 00 00 00       	call   8002bb <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  800215:	cc                   	int3   
  800216:	eb fd                	jmp    800215 <_panic+0x53>
...
putch(int ch, struct printbuf *b)
{
  ...
  80021f:	8b 5d 0c             	mov    0xc(%ebp),%ebx
	b->buf[b->idx++] = ch;
  800222:	8b 13                	mov    (%ebx),%edx
  800224:	8d 42 01             	lea    0x1(%edx),%eax
  800227:	89 03                	mov    %eax,(%ebx)
  800229:	8b 4d 08             	mov    0x8(%ebp),%ecx
  80022c:	88 4c 13 08          	mov    %cl,0x8(%ebx,%edx,1)
	if (b->idx == 256-1) {
  ...
  800245:	e8 91 fe ff ff       	call   8000db <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800296:	e8 e5 01 00 00       	call   800480 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  8002ae:	e8 28 fe ff ff       	call   8000db <sys_cputs>
