...
f010004f:	b8 b0 78 19 f0       	mov    $0xf01978b0,%eax
f0100054:	2d a0 59 19 f0       	sub    $0xf01959a0,%eax
f0100059:	50                   	push   %eax
f010005a:	6a 00                	push   $0x0
f010005c:	68 a0 59 19 f0       	push   $0xf01959a0
...
f0100091:	68 c2 ed 12 f0       	push   $0xf012edc2
...
f010009e:	ff 35 e8 5b 19 f0    	pushl  0xf0195be8
...
f01000ae:	8b 75 10             	mov    0x10(%ebp),%esi
	...
	if (panicstr)
f01000b1:	83 3d a0 78 19 f0 00 	cmpl   $0x0,0xf01978a0
f01000b8:	75 37                	jne    f01000f1 <_panic+0x48>
		goto dead;
	panicstr = fmt;
f01000ba:	89 35 a0 78 19 f0    	mov    %esi,0xf01978a0
...
f0100259:	0f 95 05 d4 5b 19 f0 	setne  0xf0195bd4
...
f01002f7:	74 13                	je     f010030c <cga_init+0x39>
		...
		addr_6845 = MONO_BASE;
f01002f9:	c7 05 d0 5b 19 f0 b4 	movl   $0x3b4,0xf0195bd0
f0100300:	03 00 00 
...
f010030c:	66 89 15 00 80 0b f0 	mov    %dx,0xf00b8000
		addr_6845 = CGA_BASE;
f0100313:	c7 05 d0 5b 19 f0 d4 	movl   $0x3d4,0xf0195bd0
f010031a:	03 00 00 
{
	volatile uint16_t *cp;
	uint16_t was;
...
f010031d:	c7 45 f0 00 80 0b f0 	movl   $0xf00b8000,-0x10(%ebp)
	...
	outb(addr_6845, 14);
f0100324:	8b 35 d0 5b 19 f0    	mov    0xf0195bd0,%esi
...
f010035c:	89 0d cc 5b 19 f0    	mov    %ecx,0xf0195bcc
	crt_pos = pos;
f0100362:	0f b6 c0             	movzbl %al,%eax
f0100365:	09 c3                	or     %eax,%ebx
f0100367:	66 89 1d c8 5b 19 f0 	mov    %bx,0xf0195bc8
}
...
f0100385:	8b 0d c4 5b 19 f0    	mov    0xf0195bc4,%ecx
f010038b:	8d 51 01             	lea    0x1(%ecx),%edx
f010038e:	89 15 c4 5b 19 f0    	mov    %edx,0xf0195bc4
f0100394:	88 81 c0 59 19 f0    	mov    %al,-0xfe6a640(%ecx)
		if (cons.wpos == CONSBUFSIZE)
f010039a:	81 fa 00 02 00 00    	cmp    $0x200,%edx
f01003a0:	75 0a                	jne    f01003ac <cons_intr+0x36>
			cons.wpos = 0;
f01003a2:	c7 05 c4 5b 19 f0 00 	movl   $0x0,0xf0195bc4
f01003a9:	00 00 00 
static void
cons_intr(int (*proc)(void))
{
...
f01003e6:	75 11                	jne    f01003f9 <kbd_proc_data+0x40>
		// E0 escape character
		shift |= E0ESC;
f01003e8:	83 0d a0 59 19 f0 40 	orl    $0x40,0xf01959a0
		return 0;
...
f01003fd:	8b 0d a0 59 19 f0    	mov    0xf01959a0,%ecx
...
f0100446:	89 15 a0 59 19 f0    	mov    %edx,0xf01959a0
	}
...
f0100456:	0b 15 a0 59 19 f0    	or     0xf01959a0,%edx
f010045c:	0f b6 88 e0 49 10 f0 	movzbl -0xfefb620(%eax),%ecx
f0100463:	31 ca                	xor    %ecx,%edx
f0100465:	89 15 a0 59 19 f0    	mov    %edx,0xf01959a0
...
f0100552:	eb 78                	jmp    f01005cc <cga_putc+0xe7>
	...
	case '\n':
		crt_pos += CRT_COLS;
f0100554:	66 83 05 c8 5b 19 f0 	addw   $0x50,0xf0195bc8
f010055b:	50 
		/* fallthru */
	case '\r':
		crt_pos -= (crt_pos % CRT_COLS);
f010055c:	0f b7 05 c8 5b 19 f0 	movzwl 0xf0195bc8,%eax
...
f0100572:	66 a3 c8 5b 19 f0    	mov    %ax,0xf0195bc8
		break;
...
f01005ae:	0f b7 15 c8 5b 19 f0 	movzwl 0xf0195bc8,%edx
f01005b5:	8d 4a 01             	lea    0x1(%edx),%ecx
f01005b8:	66 89 0d c8 5b 19 f0 	mov    %cx,0xf0195bc8
f01005bf:	0f b7 d2             	movzwl %dx,%edx
f01005c2:	8b 0d cc 5b 19 f0    	mov    0xf0195bcc,%ecx
f01005c8:	66 89 04 51          	mov    %ax,(%ecx,%edx,2)
	...
	if (crt_pos >= CRT_SIZE) {
f01005cc:	66 81 3d c8 5b 19 f0 	cmpw   $0x7cf,0xf0195bc8
f01005d3:	cf 07 
f01005d5:	76 43                	jbe    f010061a <cga_putc+0x135>
		int i;

		memmove(crt_buf, crt_buf + CRT_COLS, (CRT_SIZE - CRT_COLS) * sizeof(uint16_t));
f01005d7:	a1 cc 5b 19 f0       	mov    0xf0195bcc,%eax
...
f01005ec:	e8 ce 3e 00 00       	call   f01044bf <memmove>
		for (i = CRT_SIZE - CRT_COLS; i < CRT_SIZE; i++)
			crt_buf[i] = 0x0700 | ' ';
f01005f1:	8b 15 cc 5b 19 f0    	mov    0xf0195bcc,%edx
...
f0100610:	75 f4                	jne    f0100606 <cga_putc+0x121>
			crt_buf[i] = 0x0700 | ' ';
		crt_pos -= CRT_COLS;
f0100612:	66 83 2d c8 5b 19 f0 	subw   $0x50,0xf0195bc8
f0100619:	50 
	}

	/* move that little blinky thing */
	outb(addr_6845, 14);
f010061a:	8b 3d d0 5b 19 f0    	mov    0xf0195bd0,%edi
f0100620:	ba 0e 00 00 00       	mov    $0xe,%edx
f0100625:	89 f8                	mov    %edi,%eax
f0100627:	e8 16 fb ff ff       	call   f0100142 <outb>
	outb(addr_6845 + 1, crt_pos >> 8);
f010062c:	0f b7 1d c8 5b 19 f0 	movzwl 0xf0195bc8,%ebx
...
{
	if (serial_exists)
f0100680:	80 3d d4 5b 19 f0 00 	cmpb   $0x0,0xf0195bd4
...
f01006be:	a1 c0 5b 19 f0       	mov    0xf0195bc0,%eax
f01006c3:	3b 05 c4 5b 19 f0    	cmp    0xf0195bc4,%eax
f01006c9:	74 26                	je     f01006f1 <cons_getc+0x43>
		c = cons.buf[cons.rpos++];
f01006cb:	8d 50 01             	lea    0x1(%eax),%edx
f01006ce:	89 15 c0 5b 19 f0    	mov    %edx,0xf0195bc0
f01006d4:	0f b6 88 c0 59 19 f0 	movzbl -0xfe6a640(%eax),%ecx
...
f01006e3:	75 11                	jne    f01006f6 <cons_getc+0x48>
			cons.rpos = 0;
f01006e5:	c7 05 c0 5b 19 f0 00 	movl   $0x0,0xf0195bc0
f01006ec:	00 00 00 
...
f0100703:	e8 d9 fa ff ff       	call   f01001e1 <serial_init>
	...
	if (!serial_exists)
f0100708:	80 3d d4 5b 19 f0 00 	cmpb   $0x0,0xf0195bd4
...
f01007d9:	68 01 49 10 00       	push   $0x104901
f01007de:	68 01 49 10 f0       	push   $0xf0104901
...
f0100a40:	2b 05 ac 78 19 f0    	sub    0xf01978ac,%eax
...
f0100abc:	89 15 a4 78 19 f0    	mov    %edx,0xf01978a4
...
f0100ae9:	3b 1d a4 78 19 f0    	cmp    0xf01978a4,%ebx
...
f0100bb9 <boot_alloc>:
	...
	if (!nextfree) {
f0100bb9:	83 3d d8 5b 19 f0 00 	cmpl   $0x0,0xf0195bd8
f0100bc0:	75 11                	jne    f0100bd3 <boot_alloc+0x1a>
		extern char end[];
		nextfree = ROUNDUP((char *) end, PGSIZE);
f0100bc2:	ba af 88 19 f0       	mov    $0xf01988af,%edx
f0100bc7:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
f0100bcd:	89 15 d8 5b 19 f0    	mov    %edx,0xf0195bd8
...
f0100bd7:	a1 d8 5b 19 f0       	mov    0xf0195bd8,%eax
...
f0100c0d:	8b 15 a4 78 19 f0    	mov    0xf01978a4,%edx
...
f0100c3b:	83 ec 1c             	sub    $0x1c,%esp
	...
	pgdir = kern_pgdir;
f0100c3e:	8b 1d a8 78 19 f0    	mov    0xf01978a8,%ebx

	// check pages array
	n = ROUNDUP(npages*sizeof(struct PageInfo), PGSIZE);
f0100c44:	a1 a4 78 19 f0       	mov    0xf01978a4,%eax
...
f0100c5b:	a1 ac 78 19 f0       	mov    0xf01978ac,%eax
...
f0100cb5:	a1 e8 5b 19 f0       	mov    0xf0195be8,%eax
...
f0100f07:	a3 e0 5b 19 f0       	mov    %eax,0xf0195be0
//
static void
check_page_free_list(bool only_low_memory)
{
...
f0100f0c:	be 01 00 00 00       	mov    $0x1,%esi
	...
	for (pp = page_free_list; pp; pp = pp->pp_link)
f0100f11:	8b 1d e0 5b 19 f0    	mov    0xf0195be0,%ebx
...
f0100f54:	89 45 c8             	mov    %eax,-0x38(%ebp)
	for (pp = page_free_list; pp; pp = pp->pp_link) {
f0100f57:	8b 1d e0 5b 19 f0    	mov    0xf0195be0,%ebx
		// check that we didn't corrupt the free list itself
		assert(pp >= pages);
f0100f5d:	8b 35 ac 78 19 f0    	mov    0xf01978ac,%esi
		assert(pp < pages + npages);
f0100f63:	a1 a4 78 19 f0       	mov    0xf01978a4,%eax
...
f01010d9:	e8 cb ef ff ff       	call   f01000a9 <_panic>
	...
	if (!page_free_list)
f01010de:	8b 1d e0 5b 19 f0    	mov    0xf0195be0,%ebx
...
f01010f1:	83 3d e0 5b 19 f0 00 	cmpl   $0x0,0xf0195be0
...
f0101113:	3b 05 a4 78 19 f0    	cmp    0xf01978a4,%eax
...
f010112d:	e8 77 ef ff ff       	call   f01000a9 <_panic>
	return &pages[PGNUM(pa)];
f0101132:	8b 15 ac 78 19 f0    	mov    0xf01978ac,%edx
...
f010115f:	8b 35 e0 5b 19 f0    	mov    0xf0195be0,%esi
...
f01011c1:	8b 1d e0 5b 19 f0    	mov    0xf0195be0,%ebx
...
f01011cd:	a3 e0 5b 19 f0       	mov    %eax,0xf0195be0
	pag->pp_link = NULL;
...
f0101242:	8b 15 e0 5b 19 f0    	mov    0xf0195be0,%edx
f0101248:	89 10                	mov    %edx,(%eax)
	page_free_list=pp;
f010124a:	a3 e0 5b 19 f0       	mov    %eax,0xf0195be0
}
f010124f:	c9                   	leave  
f0101250:	c3                   	ret    
...
f0101257:	83 ec 1c             	sub    $0x1c,%esp
	...
	if (!pages)
f010125a:	83 3d ac 78 19 f0 00 	cmpl   $0x0,0xf01978ac
...
f010127a:	a1 e0 5b 19 f0       	mov    0xf0195be0,%eax
...
f010135b:	8b 0d a4 78 19 f0    	mov    0xf01978a4,%ecx
...
f01013ca:	e8 da ec ff ff       	call   f01000a9 <_panic>
	...
	fl = page_free_list;
f01013cf:	a1 e0 5b 19 f0       	mov    0xf0195be0,%eax
f01013d4:	89 45 e0             	mov    %eax,-0x20(%ebp)
	page_free_list = 0;
f01013d7:	c7 05 e0 5b 19 f0 00 	movl   $0x0,0xf0195be0
f01013de:	00 00 00 
...
f01015b5:	a3 e0 5b 19 f0       	mov    %eax,0xf0195be0
...
f01015d1:	e8 29 fc ff ff       	call   f01011ff <page_free>
	...
	for (pp = page_free_list; pp; pp = pp->pp_link)
f01015d6:	a1 e0 5b 19 f0       	mov    0xf0195be0,%eax
...
f010195f:	e8 45 e7 ff ff       	call   f01000a9 <_panic>
	...
	// temporarily steal the rest of the free pages
	fl = page_free_list;
f0101964:	a1 e0 5b 19 f0       	mov    0xf0195be0,%eax
f0101969:	89 45 cc             	mov    %eax,-0x34(%ebp)
	page_free_list = 0;
f010196c:	c7 05 e0 5b 19 f0 00 	movl   $0x0,0xf0195be0
f0101973:	00 00 00 
...
f01019a9:	ff 35 a8 78 19 f0    	pushl  0xf01978a8
...
f01019d9:	ff 35 a8 78 19 f0    	pushl  0xf01978a8
...
f0101a14:	ff 35 a8 78 19 f0    	pushl  0xf01978a8
...
f0101a3f:	8b 3d a8 78 19 f0    	mov    0xf01978a8,%edi
...
f0101b1c:	a1 a8 78 19 f0       	mov    0xf01978a8,%eax
...
f0101b9e:	ff 35 a8 78 19 f0    	pushl  0xf01978a8
...
f0101bce:	a1 a8 78 19 f0       	mov    0xf01978a8,%eax
...
f0101c48:	8b 3d a8 78 19 f0    	mov    0xf01978a8,%edi
...
f0101ca6:	ff 35 a8 78 19 f0    	pushl  0xf01978a8
...
f0101ccc:	e8 d8 e3 ff ff       	call   f01000a9 <_panic>
	assert(check_va2pa(kern_pgdir, PGSIZE) == page2pa(pp2));
f0101cd1:	8b 3d a8 78 19 f0    	mov    0xf01978a8,%edi
...
f0101d5c:	a1 a8 78 19 f0       	mov    0xf01978a8,%eax
...
f0101db7:	ff 35 a8 78 19 f0    	pushl  0xf01978a8
...
f0101ded:	ff 35 a8 78 19 f0    	pushl  0xf01978a8
...
f0101e23:	ff 35 a8 78 19 f0    	pushl  0xf01978a8
...
f0101e56:	ff 35 a8 78 19 f0    	pushl  0xf01978a8
...
f0101e8b:	ff 35 a8 78 19 f0    	pushl  0xf01978a8
...
f0101eb7:	8b 3d a8 78 19 f0    	mov    0xf01978a8,%edi
...
f0101f8e:	ff 35 a8 78 19 f0    	pushl  0xf01978a8
f0101f94:	e8 59 f8 ff ff       	call   f01017f2 <page_remove>
	assert(check_va2pa(kern_pgdir, 0x0) == ~0);
f0101f99:	8b 3d a8 78 19 f0    	mov    0xf01978a8,%edi
...
f01020b4:	ff 35 a8 78 19 f0    	pushl  0xf01978a8
f01020ba:	e8 33 f7 ff ff       	call   f01017f2 <page_remove>
	assert(check_va2pa(kern_pgdir, 0x0) == ~0);
f01020bf:	8b 3d a8 78 19 f0    	mov    0xf01978a8,%edi
...
f01021af:	e8 f5 de ff ff       	call   f01000a9 <_panic>
	...
	assert(PTE_ADDR(kern_pgdir[0]) == page2pa(pp0));
f01021b4:	8b 3d a8 78 19 f0    	mov    0xf01978a8,%edi
...
f010222c:	ff 35 a8 78 19 f0    	pushl  0xf01978a8
...
f010223d:	8b 3d a8 78 19 f0    	mov    0xf01978a8,%edi
...
f01022b8:	ff 35 a8 78 19 f0    	pushl  0xf01978a8
...
f01022fa:	75 db                	jne    f01022d7 <check_page+0xa3e>
		assert((ptep[i] & PTE_P) == 0);
	kern_pgdir[0] = 0;
f01022fc:	a1 a8 78 19 f0       	mov    0xf01978a8,%eax
...
f0102313:	89 0d e0 5b 19 f0    	mov    %ecx,0xf0195be0
...
f0102412:	ff 35 a8 78 19 f0    	pushl  0xf01978a8
...
f010246d:	ff 35 a8 78 19 f0    	pushl  0xf01978a8
...
f010251a:	ff 35 a8 78 19 f0    	pushl  0xf01978a8
...
f0102543:	e8 61 db ff ff       	call   f01000a9 <_panic>
	...
	// forcibly take pp0 back
	assert(PTE_ADDR(kern_pgdir[0]) == page2pa(pp0));
f0102548:	8b 1d a8 78 19 f0    	mov    0xf01978a8,%ebx
...
f01025dc:	a3 a8 78 19 f0       	mov    %eax,0xf01978a8
...
f01025f1:	8b 1d a8 78 19 f0    	mov    0xf01978a8,%ebx
...
f0102646:	a3 e8 5b 19 f0       	mov    %eax,0xf0195be8
...
f0102674:	8b 0d ac 78 19 f0    	mov    0xf01978ac,%ecx
...
f0102689:	8b 1d a4 78 19 f0    	mov    0xf01978a4,%ebx
...
f01026a1:	a1 a8 78 19 f0       	mov    0xf01978a8,%eax
...
f01026ab:	8b 0d e8 5b 19 f0    	mov    0xf0195be8,%ecx
...
f01026d0:	a1 a8 78 19 f0       	mov    0xf01978a8,%eax
...
f01026fe:	a1 a8 78 19 f0       	mov    0xf01978a8,%eax
...
f0102719:	a1 a8 78 19 f0       	mov    0xf01978a8,%eax
...
f0102728:	8b 0d a8 78 19 f0    	mov    0xf01978a8,%ecx
...
f0102789:	a3 dc 5b 19 f0       	mov    %eax,0xf0195bdc
		return -E_FAULT;
...
f01027a9:	c7 05 dc 5b 19 f0 00 	movl   $0xef800000,0xf0195bdc
f01027b0:	00 80 ef 
		return -E_FAULT;		
...
f01027cf:	75 0d                	jne    f01027de <user_mem_check+0x73>
			user_mem_check_addr = xva;
f01027d1:	89 1d dc 5b 19 f0    	mov    %ebx,0xf0195bdc
			return -E_FAULT;
...
f01027e7:	74 0d                	je     f01027f6 <user_mem_check+0x8b>
			user_mem_check_addr = xva;
f01027e9:	89 1d dc 5b 19 f0    	mov    %ebx,0xf0195bdc
			return -E_FAULT;
...
f0102832:	ff 35 dc 5b 19 f0    	pushl  0xf0195bdc
...
f0102876:	89 e5                	mov    %esp,%ebp
	return (pp - pages) << PGSHIFT;
f0102878:	2b 05 ac 78 19 f0    	sub    0xf01978ac,%eax
...
f0102892:	3b 1d a4 78 19 f0    	cmp    0xf01978a4,%ebx
...
f010291c:	ff 35 a8 78 19 f0    	pushl  0xf01978a8
...
f0102937:	b8 c2 59 10 f0       	mov    $0xf01059c2,%eax
...
f0102963:	3b 05 a4 78 19 f0    	cmp    0xf01978a4,%eax
...
f010297d:	e8 27 d7 ff ff       	call   f01000a9 <_panic>
	return &pages[PGNUM(pa)];
f0102982:	8b 15 ac 78 19 f0    	mov    0xf01978ac,%edx
...
f01029d1:	68 cd 59 10 f0       	push   $0xf01059cd
f01029d6:	68 22 01 00 00       	push   $0x122
f01029db:	68 c2 59 10 f0       	push   $0xf01059c2
...
f01029fc:	68 cd 59 10 f0       	push   $0xf01059cd
f0102a01:	68 25 01 00 00       	push   $0x125
f0102a06:	68 c2 59 10 f0       	push   $0xf01059c2
...
f0102a25:	68 ea 59 10 f0       	push   $0xf01059ea
f0102a2a:	68 7a 56 10 f0       	push   $0xf010567a
f0102a2f:	68 2a 01 00 00       	push   $0x12a
f0102a34:	68 c2 59 10 f0       	push   $0xf01059c2
...
f0102a98:	b8 c2 59 10 f0       	mov    $0xf01059c2,%eax
...
f0102ae8:	68 2e 5a 10 f0       	push   $0xf0105a2e
f0102aed:	68 69 01 00 00       	push   $0x169
f0102af2:	68 c2 59 10 f0       	push   $0xf01059c2
...
f0102b76:	8b 0d a8 78 19 f0    	mov    0xf01978a8,%ecx
f0102b7c:	ba 81 01 00 00       	mov    $0x181,%edx
f0102b81:	b8 c2 59 10 f0       	mov    $0xf01059c2,%eax
...
f0102ba3:	75 11                	jne    f0102bb6 <envid2env+0x1e>
		*env_store = curenv;
f0102ba5:	a1 e4 5b 19 f0       	mov    0xf0195be4,%eax
...
f0102bc3:	03 05 e8 5b 19 f0    	add    0xf0195be8,%eax
...
f0102be8:	8b 15 e4 5b 19 f0    	mov    0xf0195be4,%edx
...
f0102c4a:	8b 15 e8 5b 19 f0    	mov    0xf0195be8,%edx
...
f0102c74:	a1 e8 5b 19 f0       	mov    0xf0195be8,%eax
...
f0102c8d:	a3 ec 5b 19 f0       	mov    %eax,0xf0195bec
...
f0102c9d:	83 ec 04             	sub    $0x4,%esp
	...
	if (!(e = env_free_list))
f0102ca0:	8b 1d ec 5b 19 f0    	mov    0xf0195bec,%ebx
...
f0102cd4:	2b 15 e8 5b 19 f0    	sub    0xf0195be8,%edx
...
f0102d32:	a3 ec 5b 19 f0       	mov    %eax,0xf0195bec
	*newenv_store = e; 
...
f0102d3f:	a1 e4 5b 19 f0       	mov    0xf0195be4,%eax
...
f0102d5a:	68 3d 5a 10 f0       	push   $0xf0105a3d
...
f0102d91:	68 52 5a 10 f0       	push   $0xf0105a52
f0102d96:	68 91 01 00 00       	push   $0x191
f0102d9b:	68 c2 59 10 f0       	push   $0xf01059c2
...
f0102dc4:	8b 7d 08             	mov    0x8(%ebp),%edi
	...
	// gets reused.
	if (e == curenv)
f0102dc7:	39 3d e4 5b 19 f0    	cmp    %edi,0xf0195be4
f0102dcd:	75 1a                	jne    f0102de9 <env_free+0x2e>
		lcr3(PADDR(kern_pgdir));
f0102dcf:	8b 0d a8 78 19 f0    	mov    0xf01978a8,%ecx
f0102dd5:	ba a4 01 00 00       	mov    $0x1a4,%edx
f0102dda:	b8 c2 59 10 f0       	mov    $0xf01059c2,%eax
...
f0102dec:	a1 e4 5b 19 f0       	mov    0xf0195be4,%eax
...
f0102e04:	68 61 5a 10 f0       	push   $0xf0105a61
...
f0102e3c:	b8 c2 59 10 f0       	mov    $0xf01059c2,%eax
...
f0102eb9:	b8 c2 59 10 f0       	mov    $0xf01059c2,%eax
...
f0102edf:	a1 ec 5b 19 f0       	mov    0xf0195bec,%eax
f0102ee4:	89 47 44             	mov    %eax,0x44(%edi)
	env_free_list = e;
f0102ee7:	89 3d ec 5b 19 f0    	mov    %edi,0xf0195bec
}
...
f0102f34:	68 77 5a 10 f0       	push   $0xf0105a77
f0102f39:	68 ea 01 00 00       	push   $0x1ea
f0102f3e:	68 c2 59 10 f0       	push   $0xf01059c2
...
f0102f51:	a1 e4 5b 19 f0       	mov    0xf0195be4,%eax
...
f0102f6e:	68 83 5a 10 f0       	push   $0xf0105a83
f0102f73:	68 7a 56 10 f0       	push   $0xf010567a
f0102f78:	68 13 02 00 00       	push   $0x213
f0102f7d:	68 c2 59 10 f0       	push   $0xf01059c2
...
f0102f8c:	68 9d 5a 10 f0       	push   $0xf0105a9d
f0102f91:	68 7a 56 10 f0       	push   $0xf010567a
f0102f96:	68 14 02 00 00       	push   $0x214
f0102f9b:	68 c2 59 10 f0       	push   $0xf01059c2
f0102fa0:	e8 04 d1 ff ff       	call   f01000a9 <_panic>
	curenv=e;
f0102fa5:	89 15 e4 5b 19 f0    	mov    %edx,0xf0195be4
...
f01030a4:	8b 04 85 80 5e 10 f0 	mov    -0xfefa180(,%eax,4),%eax
f01030ab:	eb 10                	jmp    f01030bd <trapname+0x21>
	if (trapno == T_SYSCALL)
f01030ad:	83 f8 30             	cmp    $0x30,%eax
		return "System call";
	return "(unknown trap)";
f01030b0:	ba c7 5a 10 f0       	mov    $0xf0105ac7,%edx
f01030b5:	b8 bb 5a 10 f0       	mov    $0xf0105abb,%eax
...
f01030c2:	b8 20 64 19 f0       	mov    $0xf0196420,%eax
f01030c7:	c7 05 24 64 19 f0 00 	movl   $0xf0000000,0xf0196424
f01030ce:	00 00 f0 
	ts.ts_ss0 = GD_KD;
f01030d1:	66 c7 05 28 64 19 f0 	movw   $0x10,0xf0196428
f01030d8:	10 00 
...
f0103126:	68 d6 5a 10 f0       	push   $0xf0105ad6
...
f0103135:	66 a3 00 5c 19 f0    	mov    %ax,0xf0195c00
f010313b:	66 c7 05 02 5c 19 f0 	movw   $0x8,0xf0195c02
f0103142:	08 00 
f0103144:	c6 05 04 5c 19 f0 00 	movb   $0x0,0xf0195c04
f010314b:	c6 05 05 5c 19 f0 8f 	movb   $0x8f,0xf0195c05
f0103152:	c1 e8 10             	shr    $0x10,%eax
f0103155:	66 a3 06 5c 19 f0    	mov    %ax,0xf0195c06
	SETGATE(idt[1], 1, GD_KT, Trap_1, 0);
f010315b:	b8 1c 38 10 f0       	mov    $0xf010381c,%eax
f0103160:	66 a3 08 5c 19 f0    	mov    %ax,0xf0195c08
f0103166:	66 c7 05 0a 5c 19 f0 	movw   $0x8,0xf0195c0a
f010316d:	08 00 
f010316f:	c6 05 0c 5c 19 f0 00 	movb   $0x0,0xf0195c0c
f0103176:	c6 05 0d 5c 19 f0 8f 	movb   $0x8f,0xf0195c0d
f010317d:	c1 e8 10             	shr    $0x10,%eax
f0103180:	66 a3 0e 5c 19 f0    	mov    %ax,0xf0195c0e
	SETGATE(idt[2], 1, GD_KT, Trap_2, 0); 
f0103186:	b8 22 38 10 f0       	mov    $0xf0103822,%eax
f010318b:	66 a3 10 5c 19 f0    	mov    %ax,0xf0195c10
f0103191:	66 c7 05 12 5c 19 f0 	movw   $0x8,0xf0195c12
f0103198:	08 00 
f010319a:	c6 05 14 5c 19 f0 00 	movb   $0x0,0xf0195c14
f01031a1:	c6 05 15 5c 19 f0 8f 	movb   $0x8f,0xf0195c15
f01031a8:	c1 e8 10             	shr    $0x10,%eax
f01031ab:	66 a3 16 5c 19 f0    	mov    %ax,0xf0195c16
	SETGATE(idt[3], 0, GD_KT, Trap_3, 3);
f01031b1:	b8 28 38 10 f0       	mov    $0xf0103828,%eax
f01031b6:	66 a3 18 5c 19 f0    	mov    %ax,0xf0195c18
f01031bc:	66 c7 05 1a 5c 19 f0 	movw   $0x8,0xf0195c1a
f01031c3:	08 00 
f01031c5:	c6 05 1c 5c 19 f0 00 	movb   $0x0,0xf0195c1c
f01031cc:	c6 05 1d 5c 19 f0 ee 	movb   $0xee,0xf0195c1d
f01031d3:	c1 e8 10             	shr    $0x10,%eax
f01031d6:	66 a3 1e 5c 19 f0    	mov    %ax,0xf0195c1e
	SETGATE(idt[4], 1, GD_KT, Trap_4, 0);
f01031dc:	b8 2e 38 10 f0       	mov    $0xf010382e,%eax
f01031e1:	66 a3 20 5c 19 f0    	mov    %ax,0xf0195c20
f01031e7:	66 c7 05 22 5c 19 f0 	movw   $0x8,0xf0195c22
f01031ee:	08 00 
f01031f0:	c6 05 24 5c 19 f0 00 	movb   $0x0,0xf0195c24
f01031f7:	c6 05 25 5c 19 f0 8f 	movb   $0x8f,0xf0195c25
f01031fe:	c1 e8 10             	shr    $0x10,%eax
f0103201:	66 a3 26 5c 19 f0    	mov    %ax,0xf0195c26
	SETGATE(idt[5], 1, GD_KT, Trap_5, 0);
f0103207:	b8 34 38 10 f0       	mov    $0xf0103834,%eax
f010320c:	66 a3 28 5c 19 f0    	mov    %ax,0xf0195c28
f0103212:	66 c7 05 2a 5c 19 f0 	movw   $0x8,0xf0195c2a
f0103219:	08 00 
f010321b:	c6 05 2c 5c 19 f0 00 	movb   $0x0,0xf0195c2c
f0103222:	c6 05 2d 5c 19 f0 8f 	movb   $0x8f,0xf0195c2d
f0103229:	c1 e8 10             	shr    $0x10,%eax
f010322c:	66 a3 2e 5c 19 f0    	mov    %ax,0xf0195c2e
	SETGATE(idt[6], 1, GD_KT, Trap_6, 0);
f0103232:	b8 3a 38 10 f0       	mov    $0xf010383a,%eax
f0103237:	66 a3 30 5c 19 f0    	mov    %ax,0xf0195c30
f010323d:	66 c7 05 32 5c 19 f0 	movw   $0x8,0xf0195c32
f0103244:	08 00 
f0103246:	c6 05 34 5c 19 f0 00 	movb   $0x0,0xf0195c34
f010324d:	c6 05 35 5c 19 f0 8f 	movb   $0x8f,0xf0195c35
f0103254:	c1 e8 10             	shr    $0x10,%eax
f0103257:	66 a3 36 5c 19 f0    	mov    %ax,0xf0195c36
	SETGATE(idt[7], 1, GD_KT, Trap_7, 0);
f010325d:	b8 40 38 10 f0       	mov    $0xf0103840,%eax
f0103262:	66 a3 38 5c 19 f0    	mov    %ax,0xf0195c38
f0103268:	66 c7 05 3a 5c 19 f0 	movw   $0x8,0xf0195c3a
f010326f:	08 00 
f0103271:	c6 05 3c 5c 19 f0 00 	movb   $0x0,0xf0195c3c
f0103278:	c6 05 3d 5c 19 f0 8f 	movb   $0x8f,0xf0195c3d
f010327f:	c1 e8 10             	shr    $0x10,%eax
f0103282:	66 a3 3e 5c 19 f0    	mov    %ax,0xf0195c3e
	SETGATE(idt[8], 1, GD_KT, Trap_8, 0); 
f0103288:	b8 46 38 10 f0       	mov    $0xf0103846,%eax
f010328d:	66 a3 40 5c 19 f0    	mov    %ax,0xf0195c40
f0103293:	66 c7 05 42 5c 19 f0 	movw   $0x8,0xf0195c42
f010329a:	08 00 
f010329c:	c6 05 44 5c 19 f0 00 	movb   $0x0,0xf0195c44
f01032a3:	c6 05 45 5c 19 f0 8f 	movb   $0x8f,0xf0195c45
f01032aa:	c1 e8 10             	shr    $0x10,%eax
f01032ad:	66 a3 46 5c 19 f0    	mov    %ax,0xf0195c46
	SETGATE(idt[10], 1, GD_KT, Trap_10, 0); 
f01032b3:	b8 4a 38 10 f0       	mov    $0xf010384a,%eax
f01032b8:	66 a3 50 5c 19 f0    	mov    %ax,0xf0195c50
f01032be:	66 c7 05 52 5c 19 f0 	movw   $0x8,0xf0195c52
f01032c5:	08 00 
f01032c7:	c6 05 54 5c 19 f0 00 	movb   $0x0,0xf0195c54
f01032ce:	c6 05 55 5c 19 f0 8f 	movb   $0x8f,0xf0195c55
f01032d5:	c1 e8 10             	shr    $0x10,%eax
f01032d8:	66 a3 56 5c 19 f0    	mov    %ax,0xf0195c56
	SETGATE(idt[11], 1, GD_KT, Trap_11, 0); 
f01032de:	b8 4e 38 10 f0       	mov    $0xf010384e,%eax
f01032e3:	66 a3 58 5c 19 f0    	mov    %ax,0xf0195c58
f01032e9:	66 c7 05 5a 5c 19 f0 	movw   $0x8,0xf0195c5a
f01032f0:	08 00 
f01032f2:	c6 05 5c 5c 19 f0 00 	movb   $0x0,0xf0195c5c
f01032f9:	c6 05 5d 5c 19 f0 8f 	movb   $0x8f,0xf0195c5d
f0103300:	c1 e8 10             	shr    $0x10,%eax
f0103303:	66 a3 5e 5c 19 f0    	mov    %ax,0xf0195c5e
	SETGATE(idt[12], 1, GD_KT, Trap_12, 0); 
f0103309:	b8 52 38 10 f0       	mov    $0xf0103852,%eax
f010330e:	66 a3 60 5c 19 f0    	mov    %ax,0xf0195c60
f0103314:	66 c7 05 62 5c 19 f0 	movw   $0x8,0xf0195c62
f010331b:	08 00 
f010331d:	c6 05 64 5c 19 f0 00 	movb   $0x0,0xf0195c64
f0103324:	c6 05 65 5c 19 f0 8f 	movb   $0x8f,0xf0195c65
f010332b:	c1 e8 10             	shr    $0x10,%eax
f010332e:	66 a3 66 5c 19 f0    	mov    %ax,0xf0195c66
	SETGATE(idt[13], 1, GD_KT, Trap_13, 0); 
f0103334:	b8 56 38 10 f0       	mov    $0xf0103856,%eax
f0103339:	66 a3 68 5c 19 f0    	mov    %ax,0xf0195c68
f010333f:	66 c7 05 6a 5c 19 f0 	movw   $0x8,0xf0195c6a
f0103346:	08 00 
f0103348:	c6 05 6c 5c 19 f0 00 	movb   $0x0,0xf0195c6c
f010334f:	c6 05 6d 5c 19 f0 8f 	movb   $0x8f,0xf0195c6d
f0103356:	c1 e8 10             	shr    $0x10,%eax
f0103359:	66 a3 6e 5c 19 f0    	mov    %ax,0xf0195c6e
	SETGATE(idt[14], 1, GD_KT, Trap_14, 0); 
f010335f:	b8 5a 38 10 f0       	mov    $0xf010385a,%eax
f0103364:	66 a3 70 5c 19 f0    	mov    %ax,0xf0195c70
f010336a:	66 c7 05 72 5c 19 f0 	movw   $0x8,0xf0195c72
f0103371:	08 00 
f0103373:	c6 05 74 5c 19 f0 00 	movb   $0x0,0xf0195c74
f010337a:	c6 05 75 5c 19 f0 8f 	movb   $0x8f,0xf0195c75
f0103381:	c1 e8 10             	shr    $0x10,%eax
f0103384:	66 a3 76 5c 19 f0    	mov    %ax,0xf0195c76
	SETGATE(idt[16], 1, GD_KT, Trap_16, 0);
f010338a:	b8 5e 38 10 f0       	mov    $0xf010385e,%eax
f010338f:	66 a3 80 5c 19 f0    	mov    %ax,0xf0195c80
f0103395:	66 c7 05 82 5c 19 f0 	movw   $0x8,0xf0195c82
f010339c:	08 00 
f010339e:	c6 05 84 5c 19 f0 00 	movb   $0x0,0xf0195c84
f01033a5:	c6 05 85 5c 19 f0 8f 	movb   $0x8f,0xf0195c85
f01033ac:	c1 e8 10             	shr    $0x10,%eax
f01033af:	66 a3 86 5c 19 f0    	mov    %ax,0xf0195c86
	SETGATE(idt[17], 1, GD_KT, Trap_17, 0); 
f01033b5:	b8 64 38 10 f0       	mov    $0xf0103864,%eax
f01033ba:	66 a3 88 5c 19 f0    	mov    %ax,0xf0195c88
f01033c0:	66 c7 05 8a 5c 19 f0 	movw   $0x8,0xf0195c8a
f01033c7:	08 00 
f01033c9:	c6 05 8c 5c 19 f0 00 	movb   $0x0,0xf0195c8c
f01033d0:	c6 05 8d 5c 19 f0 8f 	movb   $0x8f,0xf0195c8d
f01033d7:	c1 e8 10             	shr    $0x10,%eax
f01033da:	66 a3 8e 5c 19 f0    	mov    %ax,0xf0195c8e
	SETGATE(idt[18], 1, GD_KT, Trap_18, 0); 
f01033e0:	b8 68 38 10 f0       	mov    $0xf0103868,%eax
f01033e5:	66 a3 90 5c 19 f0    	mov    %ax,0xf0195c90
f01033eb:	66 c7 05 92 5c 19 f0 	movw   $0x8,0xf0195c92
f01033f2:	08 00 
f01033f4:	c6 05 94 5c 19 f0 00 	movb   $0x0,0xf0195c94
f01033fb:	c6 05 95 5c 19 f0 8f 	movb   $0x8f,0xf0195c95
f0103402:	c1 e8 10             	shr    $0x10,%eax
f0103405:	66 a3 96 5c 19 f0    	mov    %ax,0xf0195c96
	SETGATE(idt[19], 1, GD_KT, Trap_19, 0); 
f010340b:	b8 6e 38 10 f0       	mov    $0xf010386e,%eax
f0103410:	66 a3 98 5c 19 f0    	mov    %ax,0xf0195c98
f0103416:	66 c7 05 9a 5c 19 f0 	movw   $0x8,0xf0195c9a
f010341d:	08 00 
f010341f:	c6 05 9c 5c 19 f0 00 	movb   $0x0,0xf0195c9c
f0103426:	c6 05 9d 5c 19 f0 8f 	movb   $0x8f,0xf0195c9d
f010342d:	c1 e8 10             	shr    $0x10,%eax
f0103430:	66 a3 9e 5c 19 f0    	mov    %ax,0xf0195c9e
	SETGATE(idt[48], 0, GD_KT, Trap_48, 3);
f0103436:	b8 74 38 10 f0       	mov    $0xf0103874,%eax
f010343b:	66 a3 80 5d 19 f0    	mov    %ax,0xf0195d80
f0103441:	66 c7 05 82 5d 19 f0 	movw   $0x8,0xf0195d82
f0103448:	08 00 
f010344a:	c6 05 84 5d 19 f0 00 	movb   $0x0,0xf0195d84
f0103451:	c6 05 85 5d 19 f0 ee 	movb   $0xee,0xf0195d85
f0103458:	c1 e8 10             	shr    $0x10,%eax
f010345b:	66 a3 86 5d 19 f0    	mov    %ax,0xf0195d86

	cprintf("Se setearon los gates\n");
f0103461:	c7 04 24 ec 5a 10 f0 	movl   $0xf0105aec,(%esp)
...
f0103511:	68 a0 5c 10 f0       	push   $0xf0105ca0
...
f010352b:	68 a2 5b 10 f0       	push   $0xf0105ba2
...
f010353d:	68 b5 5b 10 f0       	push   $0xf0105bb5
...
f010357a:	68 da 5b 10 f0       	push   $0xf0105bda
...
f010358d:	68 e9 5b 10 f0       	push   $0xf0105be9
...
f01035a8:	ba 86 5b 10 f0       	mov    $0xf0105b86,%edx
f01035ad:	b9 7b 5b 10 f0       	mov    $0xf0105b7b,%ecx
f01035b2:	0f 44 ca             	cmove  %edx,%ecx
f01035b5:	89 c2                	mov    %eax,%edx
f01035b7:	83 e2 02             	and    $0x2,%edx
f01035ba:	ba 98 5b 10 f0       	mov    $0xf0105b98,%edx
f01035bf:	be 92 5b 10 f0       	mov    $0xf0105b92,%esi
f01035c4:	0f 45 d6             	cmovne %esi,%edx
f01035c7:	83 e0 04             	and    $0x4,%eax
f01035ca:	be 77 5c 10 f0       	mov    $0xf0105c77,%esi
f01035cf:	b8 9d 5b 10 f0       	mov    $0xf0105b9d,%eax
f01035d4:	0f 44 c6             	cmove  %esi,%eax
f01035d7:	51                   	push   %ecx
f01035d8:	52                   	push   %edx
f01035d9:	50                   	push   %eax
f01035da:	68 f7 5b 10 f0       	push   $0xf0105bf7
...
f01035ec:	68 ea 5a 10 f0       	push   $0xf0105aea
...
f01035ff:	68 06 5c 10 f0       	push   $0xf0105c06
...
f010363a:	68 37 5c 10 f0       	push   $0xf0105c37
...
f010364c:	68 46 5c 10 f0       	push   $0xf0105c46
...
f010367c:	68 fc 5d 10 f0       	push   $0xf0105dfc
f0103681:	68 0b 01 00 00       	push   $0x10b
f0103686:	68 59 5c 10 f0       	push   $0xf0105c59
...
f0103694:	a1 e4 5b 19 f0       	mov    0xf0195be4,%eax
f0103699:	ff 70 48             	pushl  0x48(%eax)
f010369c:	68 20 5e 10 f0       	push   $0xf0105e20
...
f01036b1:	ff 35 e4 5b 19 f0    	pushl  0xf0195be4
...
f0103732:	68 65 5c 10 f0       	push   $0xf0105c65
f0103737:	68 d0 00 00 00       	push   $0xd0
f010373c:	68 59 5c 10 f0       	push   $0xf0105c59
f0103741:	e8 63 c9 ff ff       	call   f01000a9 <_panic>
	else {
		env_destroy(curenv);
f0103746:	83 ec 0c             	sub    $0xc,%esp
f0103749:	ff 35 e4 5b 19 f0    	pushl  0xf0195be4
...
f010376f:	68 7e 5c 10 f0       	push   $0xf0105c7e
f0103774:	68 7a 56 10 f0       	push   $0xf010567a
f0103779:	68 e1 00 00 00       	push   $0xe1
f010377e:	68 59 5c 10 f0       	push   $0xf0105c59
f0103783:	e8 21 c9 ff ff       	call   f01000a9 <_panic>

	cprintf("Incoming TRAP frame at %p\n", tf);
f0103788:	83 ec 08             	sub    $0x8,%esp
f010378b:	56                   	push   %esi
f010378c:	68 97 5c 10 f0       	push   $0xf0105c97
...
f01037a4:	75 31                	jne    f01037d7 <trap+0x7b>
		...
		assert(curenv);
f01037a6:	a1 e4 5b 19 f0       	mov    0xf0195be4,%eax
f01037ab:	85 c0                	test   %eax,%eax
f01037ad:	75 19                	jne    f01037c8 <trap+0x6c>
f01037af:	68 b2 5c 10 f0       	push   $0xf0105cb2
f01037b4:	68 7a 56 10 f0       	push   $0xf010567a
f01037b9:	68 e7 00 00 00       	push   $0xe7
f01037be:	68 59 5c 10 f0       	push   $0xf0105c59
...
f01037cf:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
		...
		tf = &curenv->env_tf;
f01037d1:	8b 35 e4 5b 19 f0    	mov    0xf0195be4,%esi
	}

	// Record that tf is the last real trapframe so
	// print_trapframe can print some additional information.
	last_tf = tf;
f01037d7:	89 35 00 64 19 f0    	mov    %esi,0xf0196400
...
f01037e4:	a1 e4 5b 19 f0       	mov    0xf0195be4,%eax
...
f01037f3:	68 44 5e 10 f0       	push   $0xf0105e44
f01037f8:	68 7a 56 10 f0       	push   $0xf010567a
f01037fd:	68 f9 00 00 00       	push   $0xf9
f0103802:	68 59 5c 10 f0       	push   $0xf0105c59
...
f010388e:	83 ec 14             	sub    $0x14,%esp
	cprintf("Entre a f3()\n");
f0103891:	68 d0 5e 10 f0       	push   $0xf0105ed0
f0103896:	e8 ce f7 ff ff       	call   f0103069 <cprintf>
	return curenv->env_id;
f010389b:	a1 e4 5b 19 f0       	mov    0xf0195be4,%eax
...
f01038b2:	ff 35 e4 5b 19 f0    	pushl  0xf0195be4
...
f01038c2:	68 de 5e 10 f0       	push   $0xf0105ede
...
f01038d9:	83 ec 14             	sub    $0x14,%esp
	cprintf("Entre a f2()\n");
f01038dc:	68 e3 5e 10 f0       	push   $0xf0105ee3
...
f01038f4:	89 c3                	mov    %eax,%ebx
	cprintf("Entre a f4()\n");
f01038f6:	68 f1 5e 10 f0       	push   $0xf0105ef1
...
f0103919:	8b 15 e4 5b 19 f0    	mov    0xf0195be4,%edx
...
f0103929:	68 ff 5e 10 f0       	push   $0xf0105eff
...
f0103941:	68 1a 5f 10 f0       	push   $0xf0105f1a
...
f0103970:	68 32 5f 10 f0       	push   $0xf0105f32
...
f0103ac5:	c7 03 45 5f 10 f0    	movl   $0xf0105f45,(%ebx)
	info->eip_line = 0;
f0103acb:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
	info->eip_fn_name = "<unknown>";
f0103ad2:	c7 43 08 45 5f 10 f0 	movl   $0xf0105f45,0x8(%ebx)
...
f0103b13:	c7 45 bc 61 61 10 f0 	movl   $0xf0106161,-0x44(%ebp)
	...
	if (addr >= ULIM) {
		...
		stab_end = __STAB_END__;
		stabstr = __STABSTR_BEGIN__;
f0103b1a:	c7 45 b8 61 61 10 f0 	movl   $0xf0106161,-0x48(%ebp)
	info->eip_fn_narg = 0;
	...
	if (addr >= ULIM) {
		stabs = __STAB_BEGIN__;
		stab_end = __STAB_END__;
f0103b21:	b8 60 61 10 f0       	mov    $0xf0106160,%eax
	info->eip_fn_addr = addr;
	info->eip_fn_narg = 0;
	...
	if (addr >= ULIM) {
		stabs = __STAB_BEGIN__;
f0103b26:	c7 45 c0 60 61 10 f0 	movl   $0xf0106160,-0x40(%ebp)
...
f0103d44:	e8 37 09 00 00       	call   f0104680 <__udivdi3>
...
f0103d87:	e8 24 0a 00 00       	call   f01047b0 <__umoddi3>
f0103d8c:	83 c4 14             	add    $0x14,%esp
f0103d8f:	0f be 80 4f 5f 10 f0 	movsbl -0xfefa0b1(%eax),%eax
...
f0103ebd:	ff 24 85 dc 5f 10 f0 	jmp    *-0xfefa024(,%eax,4)
...
f0103fa5:	68 8c 56 10 f0       	push   $0xf010568c
...
f0103fc9:	b8 60 5f 10 f0       	mov    $0xf0105f60,%eax
...
f010422e:	68 8c 56 10 f0       	push   $0xf010568c
...
f010425e:	68 50 61 10 f0       	push   $0xf0106150
...
f01042b6:	83 c4 10             	add    $0x10,%esp
			buf[i++] = c;
f01042b9:	88 9e a0 64 19 f0    	mov    %bl,-0xfe69b60(%esi)
...
f01042dc:	83 c4 10             	add    $0x10,%esp
			buf[i] = 0;
f01042df:	c6 86 a0 64 19 f0 00 	movb   $0x0,-0xfe69b60(%esi)
			return buf;
f01042e6:	b8 a0 64 19 f0       	mov    $0xf01964a0,%eax
		}
	}
}
...
f010457c:	03 4d 10             	add    0x10(%ebp),%ecx
	for (; s < ends; s++)
		if (*(const unsigned char *) s == (unsigned char) c)
f010457f:	0f b6 5d 0c          	movzbl 0xc(%ebp),%ebx
...
memfind(const void *s, int c, size_t n)
{
	const void *ends = (const char *) s + n;
	for (; s < ends; s++)
f0104583:	eb 0a                	jmp    f010458f <memfind+0x1c>
		if (*(const unsigned char *) s == (unsigned char) c)
f0104585:	0f b6 10             	movzbl (%eax),%edx
f0104588:	39 da                	cmp    %ebx,%edx
f010458a:	74 07                	je     f0104593 <memfind+0x20>
...
memfind(const void *s, int c, size_t n)
{
	const void *ends = (const char *) s + n;
	for (; s < ends; s++)
f010458c:	83 c0 01             	add    $0x1,%eax
f010458f:	39 c8                	cmp    %ecx,%eax
f0104591:	72 f2                	jb     f0104585 <memfind+0x12>
		if (*(const unsigned char *) s == (unsigned char) c)
			break;
	return (void *) s;
}
...
f010459a:	56                   	push   %esi
f010459b:	53                   	push   %ebx
f010459c:	8b 4d 08             	mov    0x8(%ebp),%ecx
f010459f:	8b 5d 10             	mov    0x10(%ebp),%ebx
	int neg = 0;
	long val = 0;

	// gobble initial whitespace
	while (*s == ' ' || *s == '\t')
f01045a2:	eb 03                	jmp    f01045a7 <strtol+0x11>
		s++;
f01045a4:	83 c1 01             	add    $0x1,%ecx
{
	int neg = 0;
	long val = 0;
	...
	// gobble initial whitespace
	while (*s == ' ' || *s == '\t')
f01045a7:	0f b6 01             	movzbl (%ecx),%eax
f01045aa:	3c 20                	cmp    $0x20,%al
f01045ac:	74 f6                	je     f01045a4 <strtol+0xe>
f01045ae:	3c 09                	cmp    $0x9,%al
f01045b0:	74 f2                	je     f01045a4 <strtol+0xe>
		s++;

	// plus/minus sign
	if (*s == '+')
f01045b2:	3c 2b                	cmp    $0x2b,%al
f01045b4:	75 0a                	jne    f01045c0 <strtol+0x2a>
		s++;
...
{
	int neg = 0;
f01045b9:	bf 00 00 00 00       	mov    $0x0,%edi
f01045be:	eb 11                	jmp    f01045d1 <strtol+0x3b>
f01045c0:	bf 00 00 00 00       	mov    $0x0,%edi
		s++;
...
f01045c5:	3c 2d                	cmp    $0x2d,%al
f01045c7:	75 08                	jne    f01045d1 <strtol+0x3b>
		s++, neg = 1;
f01045c9:	83 c1 01             	add    $0x1,%ecx
f01045cc:	bf 01 00 00 00       	mov    $0x1,%edi

	// hex or octal base prefix
	if ((base == 0 || base == 16) && (s[0] == '0' && s[1] == 'x'))
f01045d1:	f7 c3 ef ff ff ff    	test   $0xffffffef,%ebx
f01045d7:	75 15                	jne    f01045ee <strtol+0x58>
f01045d9:	80 39 30             	cmpb   $0x30,(%ecx)
f01045dc:	75 10                	jne    f01045ee <strtol+0x58>
f01045de:	80 79 01 78          	cmpb   $0x78,0x1(%ecx)
f01045e2:	75 7c                	jne    f0104660 <strtol+0xca>
		s += 2, base = 16;
f01045e4:	83 c1 02             	add    $0x2,%ecx
f01045e7:	bb 10 00 00 00       	mov    $0x10,%ebx
f01045ec:	eb 16                	jmp    f0104604 <strtol+0x6e>
	else if (base == 0 && s[0] == '0')
f01045ee:	85 db                	test   %ebx,%ebx
f01045f0:	75 12                	jne    f0104604 <strtol+0x6e>
		s++, base = 8;
	else if (base == 0)
		base = 10;
f01045f2:	bb 0a 00 00 00       	mov    $0xa,%ebx
		s++, neg = 1;
...
f01045f7:	80 39 30             	cmpb   $0x30,(%ecx)
f01045fa:	75 08                	jne    f0104604 <strtol+0x6e>
		s++, base = 8;
f01045fc:	83 c1 01             	add    $0x1,%ecx
f01045ff:	bb 08 00 00 00       	mov    $0x8,%ebx
	else if (base == 0)
		base = 10;
f0104604:	b8 00 00 00 00       	mov    $0x0,%eax
f0104609:	89 5d 10             	mov    %ebx,0x10(%ebp)
	...
	while (1) {
		...
		if (*s >= '0' && *s <= '9')
f010460c:	0f b6 11             	movzbl (%ecx),%edx
f010460f:	8d 72 d0             	lea    -0x30(%edx),%esi
f0104612:	89 f3                	mov    %esi,%ebx
f0104614:	80 fb 09             	cmp    $0x9,%bl
f0104617:	77 08                	ja     f0104621 <strtol+0x8b>
			dig = *s - '0';
f0104619:	0f be d2             	movsbl %dl,%edx
f010461c:	83 ea 30             	sub    $0x30,%edx
f010461f:	eb 22                	jmp    f0104643 <strtol+0xad>
		else if (*s >= 'a' && *s <= 'z')
f0104621:	8d 72 9f             	lea    -0x61(%edx),%esi
f0104624:	89 f3                	mov    %esi,%ebx
f0104626:	80 fb 19             	cmp    $0x19,%bl
f0104629:	77 08                	ja     f0104633 <strtol+0x9d>
			dig = *s - 'a' + 10;
f010462b:	0f be d2             	movsbl %dl,%edx
f010462e:	83 ea 57             	sub    $0x57,%edx
f0104631:	eb 10                	jmp    f0104643 <strtol+0xad>
		else if (*s >= 'A' && *s <= 'Z')
f0104633:	8d 72 bf             	lea    -0x41(%edx),%esi
f0104636:	89 f3                	mov    %esi,%ebx
f0104638:	80 fb 19             	cmp    $0x19,%bl
f010463b:	77 16                	ja     f0104653 <strtol+0xbd>
			dig = *s - 'A' + 10;
f010463d:	0f be d2             	movsbl %dl,%edx
f0104640:	83 ea 37             	sub    $0x37,%edx
		else
			break;
		if (dig >= base)
f0104643:	3b 55 10             	cmp    0x10(%ebp),%edx
f0104646:	7d 0b                	jge    f0104653 <strtol+0xbd>
			break;
		s++, val = (val * base) + dig;
f0104648:	83 c1 01             	add    $0x1,%ecx
f010464b:	0f af 45 10          	imul   0x10(%ebp),%eax
f010464f:	01 d0                	add    %edx,%eax
		// we don't properly detect overflow!
	}
f0104651:	eb b9                	jmp    f010460c <strtol+0x76>

	if (endptr)
f0104653:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
f0104657:	74 0d                	je     f0104666 <strtol+0xd0>
		*endptr = (char *) s;
f0104659:	8b 75 0c             	mov    0xc(%ebp),%esi
f010465c:	89 0e                	mov    %ecx,(%esi)
f010465e:	eb 06                	jmp    f0104666 <strtol+0xd0>
		s++, neg = 1;
...
f0104660:	85 db                	test   %ebx,%ebx
f0104662:	74 98                	je     f01045fc <strtol+0x66>
f0104664:	eb 9e                	jmp    f0104604 <strtol+0x6e>
		// we don't properly detect overflow!
	}
	...
	if (endptr)
		*endptr = (char *) s;
	return (neg ? -val : val);
f0104666:	89 c2                	mov    %eax,%edx
f0104668:	f7 da                	neg    %edx
f010466a:	85 ff                	test   %edi,%edi
f010466c:	0f 45 c2             	cmovne %edx,%eax
}
f010466f:	5b                   	pop    %ebx
f0104670:	5e                   	pop    %esi
f0104671:	5f                   	pop    %edi
...
f0104683:	53                   	push   %ebx
f0104684:	83 ec 1c             	sub    $0x1c,%esp
f0104687:	8b 74 24 3c          	mov    0x3c(%esp),%esi
f010468b:	8b 5c 24 30          	mov    0x30(%esp),%ebx
f010468f:	8b 4c 24 34          	mov    0x34(%esp),%ecx
f0104693:	8b 7c 24 38          	mov    0x38(%esp),%edi
f0104697:	85 f6                	test   %esi,%esi
f0104699:	89 5c 24 08          	mov    %ebx,0x8(%esp)
f010469d:	89 ca                	mov    %ecx,%edx
f010469f:	89 f8                	mov    %edi,%eax
f01046a1:	75 3d                	jne    f01046e0 <__udivdi3+0x60>
f01046a3:	39 cf                	cmp    %ecx,%edi
f01046a5:	0f 87 c5 00 00 00    	ja     f0104770 <__udivdi3+0xf0>
f01046ab:	85 ff                	test   %edi,%edi
f01046ad:	89 fd                	mov    %edi,%ebp
f01046af:	75 0b                	jne    f01046bc <__udivdi3+0x3c>
f01046b1:	b8 01 00 00 00       	mov    $0x1,%eax
f01046b6:	31 d2                	xor    %edx,%edx
f01046b8:	f7 f7                	div    %edi
f01046ba:	89 c5                	mov    %eax,%ebp
f01046bc:	89 c8                	mov    %ecx,%eax
f01046be:	31 d2                	xor    %edx,%edx
f01046c0:	f7 f5                	div    %ebp
f01046c2:	89 c1                	mov    %eax,%ecx
f01046c4:	89 d8                	mov    %ebx,%eax
f01046c6:	89 cf                	mov    %ecx,%edi
f01046c8:	f7 f5                	div    %ebp
f01046ca:	89 c3                	mov    %eax,%ebx
f01046cc:	89 d8                	mov    %ebx,%eax
f01046ce:	89 fa                	mov    %edi,%edx
f01046d0:	83 c4 1c             	add    $0x1c,%esp
f01046d3:	5b                   	pop    %ebx
f01046d4:	5e                   	pop    %esi
f01046d5:	5f                   	pop    %edi
f01046d6:	5d                   	pop    %ebp
...
f01046e0:	39 ce                	cmp    %ecx,%esi
f01046e2:	77 74                	ja     f0104758 <__udivdi3+0xd8>
f01046e4:	0f bd fe             	bsr    %esi,%edi
f01046e7:	83 f7 1f             	xor    $0x1f,%edi
f01046ea:	0f 84 98 00 00 00    	je     f0104788 <__udivdi3+0x108>
f01046f0:	bb 20 00 00 00       	mov    $0x20,%ebx
f01046f5:	89 f9                	mov    %edi,%ecx
f01046f7:	89 c5                	mov    %eax,%ebp
f01046f9:	29 fb                	sub    %edi,%ebx
f01046fb:	d3 e6                	shl    %cl,%esi
f01046fd:	89 d9                	mov    %ebx,%ecx
f01046ff:	d3 ed                	shr    %cl,%ebp
f0104701:	89 f9                	mov    %edi,%ecx
f0104703:	d3 e0                	shl    %cl,%eax
f0104705:	09 ee                	or     %ebp,%esi
f0104707:	89 d9                	mov    %ebx,%ecx
f0104709:	89 44 24 0c          	mov    %eax,0xc(%esp)
f010470d:	89 d5                	mov    %edx,%ebp
f010470f:	8b 44 24 08          	mov    0x8(%esp),%eax
f0104713:	d3 ed                	shr    %cl,%ebp
f0104715:	89 f9                	mov    %edi,%ecx
f0104717:	d3 e2                	shl    %cl,%edx
f0104719:	89 d9                	mov    %ebx,%ecx
f010471b:	d3 e8                	shr    %cl,%eax
f010471d:	09 c2                	or     %eax,%edx
f010471f:	89 d0                	mov    %edx,%eax
f0104721:	89 ea                	mov    %ebp,%edx
f0104723:	f7 f6                	div    %esi
f0104725:	89 d5                	mov    %edx,%ebp
f0104727:	89 c3                	mov    %eax,%ebx
f0104729:	f7 64 24 0c          	mull   0xc(%esp)
f010472d:	39 d5                	cmp    %edx,%ebp
f010472f:	72 10                	jb     f0104741 <__udivdi3+0xc1>
f0104731:	8b 74 24 08          	mov    0x8(%esp),%esi
f0104735:	89 f9                	mov    %edi,%ecx
f0104737:	d3 e6                	shl    %cl,%esi
f0104739:	39 c6                	cmp    %eax,%esi
f010473b:	73 07                	jae    f0104744 <__udivdi3+0xc4>
f010473d:	39 d5                	cmp    %edx,%ebp
f010473f:	75 03                	jne    f0104744 <__udivdi3+0xc4>
f0104741:	83 eb 01             	sub    $0x1,%ebx
f0104744:	31 ff                	xor    %edi,%edi
f0104746:	89 d8                	mov    %ebx,%eax
f0104748:	89 fa                	mov    %edi,%edx
f010474a:	83 c4 1c             	add    $0x1c,%esp
f010474d:	5b                   	pop    %ebx
f010474e:	5e                   	pop    %esi
f010474f:	5f                   	pop    %edi
f0104750:	5d                   	pop    %ebp
...
f0104758:	31 ff                	xor    %edi,%edi
f010475a:	31 db                	xor    %ebx,%ebx
f010475c:	89 d8                	mov    %ebx,%eax
f010475e:	89 fa                	mov    %edi,%edx
f0104760:	83 c4 1c             	add    $0x1c,%esp
f0104763:	5b                   	pop    %ebx
f0104764:	5e                   	pop    %esi
f0104765:	5f                   	pop    %edi
f0104766:	5d                   	pop    %ebp
...
f0104770:	89 d8                	mov    %ebx,%eax
f0104772:	f7 f7                	div    %edi
f0104774:	31 ff                	xor    %edi,%edi
f0104776:	89 c3                	mov    %eax,%ebx
f0104778:	89 d8                	mov    %ebx,%eax
f010477a:	89 fa                	mov    %edi,%edx
f010477c:	83 c4 1c             	add    $0x1c,%esp
f010477f:	5b                   	pop    %ebx
f0104780:	5e                   	pop    %esi
f0104781:	5f                   	pop    %edi
f0104782:	5d                   	pop    %ebp
...
f0104788:	39 ce                	cmp    %ecx,%esi
f010478a:	72 0c                	jb     f0104798 <__udivdi3+0x118>
f010478c:	31 db                	xor    %ebx,%ebx
f010478e:	3b 44 24 08          	cmp    0x8(%esp),%eax
f0104792:	0f 87 34 ff ff ff    	ja     f01046cc <__udivdi3+0x4c>
f0104798:	bb 01 00 00 00       	mov    $0x1,%ebx
f010479d:	e9 2a ff ff ff       	jmp    f01046cc <__udivdi3+0x4c>
f01047a2:	66 90                	xchg   %ax,%ax
f01047a4:	66 90                	xchg   %ax,%ax
f01047a6:	66 90                	xchg   %ax,%ax
f01047a8:	66 90                	xchg   %ax,%ax
f01047aa:	66 90                	xchg   %ax,%ax
...
f01047b7:	8b 54 24 3c          	mov    0x3c(%esp),%edx
f01047bb:	8b 4c 24 30          	mov    0x30(%esp),%ecx
f01047bf:	8b 74 24 34          	mov    0x34(%esp),%esi
f01047c3:	8b 7c 24 38          	mov    0x38(%esp),%edi
f01047c7:	85 d2                	test   %edx,%edx
f01047c9:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
f01047cd:	89 4c 24 08          	mov    %ecx,0x8(%esp)
f01047d1:	89 f3                	mov    %esi,%ebx
f01047d3:	89 3c 24             	mov    %edi,(%esp)
f01047d6:	89 74 24 04          	mov    %esi,0x4(%esp)
f01047da:	75 1c                	jne    f01047f8 <__umoddi3+0x48>
f01047dc:	39 f7                	cmp    %esi,%edi
f01047de:	76 50                	jbe    f0104830 <__umoddi3+0x80>
f01047e0:	89 c8                	mov    %ecx,%eax
f01047e2:	89 f2                	mov    %esi,%edx
f01047e4:	f7 f7                	div    %edi
f01047e6:	89 d0                	mov    %edx,%eax
f01047e8:	31 d2                	xor    %edx,%edx
f01047ea:	83 c4 1c             	add    $0x1c,%esp
f01047ed:	5b                   	pop    %ebx
f01047ee:	5e                   	pop    %esi
f01047ef:	5f                   	pop    %edi
f01047f0:	5d                   	pop    %ebp
f01047f1:	c3                   	ret    
f01047f2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
f01047f8:	39 f2                	cmp    %esi,%edx
f01047fa:	89 d0                	mov    %edx,%eax
f01047fc:	77 52                	ja     f0104850 <__umoddi3+0xa0>
f01047fe:	0f bd ea             	bsr    %edx,%ebp
f0104801:	83 f5 1f             	xor    $0x1f,%ebp
f0104804:	75 5a                	jne    f0104860 <__umoddi3+0xb0>
f0104806:	3b 54 24 04          	cmp    0x4(%esp),%edx
f010480a:	0f 82 e0 00 00 00    	jb     f01048f0 <__umoddi3+0x140>
f0104810:	39 0c 24             	cmp    %ecx,(%esp)
f0104813:	0f 86 d7 00 00 00    	jbe    f01048f0 <__umoddi3+0x140>
f0104819:	8b 44 24 08          	mov    0x8(%esp),%eax
f010481d:	8b 54 24 04          	mov    0x4(%esp),%edx
...
f0104830:	85 ff                	test   %edi,%edi
f0104832:	89 fd                	mov    %edi,%ebp
f0104834:	75 0b                	jne    f0104841 <__umoddi3+0x91>
f0104836:	b8 01 00 00 00       	mov    $0x1,%eax
f010483b:	31 d2                	xor    %edx,%edx
f010483d:	f7 f7                	div    %edi
f010483f:	89 c5                	mov    %eax,%ebp
f0104841:	89 f0                	mov    %esi,%eax
f0104843:	31 d2                	xor    %edx,%edx
f0104845:	f7 f5                	div    %ebp
f0104847:	89 c8                	mov    %ecx,%eax
f0104849:	f7 f5                	div    %ebp
f010484b:	89 d0                	mov    %edx,%eax
f010484d:	eb 99                	jmp    f01047e8 <__umoddi3+0x38>
f010484f:	90                   	nop
f0104850:	89 c8                	mov    %ecx,%eax
f0104852:	89 f2                	mov    %esi,%edx
f0104854:	83 c4 1c             	add    $0x1c,%esp
f0104857:	5b                   	pop    %ebx
f0104858:	5e                   	pop    %esi
f0104859:	5f                   	pop    %edi
f010485a:	5d                   	pop    %ebp
f010485b:	c3                   	ret    
f010485c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
f0104860:	8b 34 24             	mov    (%esp),%esi
f0104863:	bf 20 00 00 00       	mov    $0x20,%edi
f0104868:	89 e9                	mov    %ebp,%ecx
f010486a:	29 ef                	sub    %ebp,%edi
f010486c:	d3 e0                	shl    %cl,%eax
f010486e:	89 f9                	mov    %edi,%ecx
f0104870:	89 f2                	mov    %esi,%edx
f0104872:	d3 ea                	shr    %cl,%edx
f0104874:	89 e9                	mov    %ebp,%ecx
f0104876:	09 c2                	or     %eax,%edx
f0104878:	89 d8                	mov    %ebx,%eax
f010487a:	89 14 24             	mov    %edx,(%esp)
f010487d:	89 f2                	mov    %esi,%edx
f010487f:	d3 e2                	shl    %cl,%edx
f0104881:	89 f9                	mov    %edi,%ecx
f0104883:	89 54 24 04          	mov    %edx,0x4(%esp)
f0104887:	8b 54 24 0c          	mov    0xc(%esp),%edx
f010488b:	d3 e8                	shr    %cl,%eax
f010488d:	89 e9                	mov    %ebp,%ecx
f010488f:	89 c6                	mov    %eax,%esi
f0104891:	d3 e3                	shl    %cl,%ebx
f0104893:	89 f9                	mov    %edi,%ecx
f0104895:	89 d0                	mov    %edx,%eax
f0104897:	d3 e8                	shr    %cl,%eax
f0104899:	89 e9                	mov    %ebp,%ecx
f010489b:	09 d8                	or     %ebx,%eax
f010489d:	89 d3                	mov    %edx,%ebx
f010489f:	89 f2                	mov    %esi,%edx
f01048a1:	f7 34 24             	divl   (%esp)
f01048a4:	89 d6                	mov    %edx,%esi
f01048a6:	d3 e3                	shl    %cl,%ebx
f01048a8:	f7 64 24 04          	mull   0x4(%esp)
f01048ac:	39 d6                	cmp    %edx,%esi
f01048ae:	89 5c 24 08          	mov    %ebx,0x8(%esp)
f01048b2:	89 d1                	mov    %edx,%ecx
f01048b4:	89 c3                	mov    %eax,%ebx
f01048b6:	72 08                	jb     f01048c0 <__umoddi3+0x110>
f01048b8:	75 11                	jne    f01048cb <__umoddi3+0x11b>
f01048ba:	39 44 24 08          	cmp    %eax,0x8(%esp)
f01048be:	73 0b                	jae    f01048cb <__umoddi3+0x11b>
f01048c0:	2b 44 24 04          	sub    0x4(%esp),%eax
f01048c4:	1b 14 24             	sbb    (%esp),%edx
f01048c7:	89 d1                	mov    %edx,%ecx
f01048c9:	89 c3                	mov    %eax,%ebx
f01048cb:	8b 54 24 08          	mov    0x8(%esp),%edx
f01048cf:	29 da                	sub    %ebx,%edx
f01048d1:	19 ce                	sbb    %ecx,%esi
f01048d3:	89 f9                	mov    %edi,%ecx
f01048d5:	89 f0                	mov    %esi,%eax
f01048d7:	d3 e0                	shl    %cl,%eax
f01048d9:	89 e9                	mov    %ebp,%ecx
f01048db:	d3 ea                	shr    %cl,%edx
f01048dd:	89 e9                	mov    %ebp,%ecx
f01048df:	d3 ee                	shr    %cl,%esi
f01048e1:	09 d0                	or     %edx,%eax
f01048e3:	89 f2                	mov    %esi,%edx
f01048e5:	83 c4 1c             	add    $0x1c,%esp
f01048e8:	5b                   	pop    %ebx
f01048e9:	5e                   	pop    %esi
f01048ea:	5f                   	pop    %edi
f01048eb:	5d                   	pop    %ebp
...
f01048f0:	29 f9                	sub    %edi,%ecx
f01048f2:	19 d6                	sbb    %edx,%esi
f01048f4:	89 74 24 04          	mov    %esi,0x4(%esp)
f01048f8:	89 4c 24 08          	mov    %ecx,0x8(%esp)
f01048fc:	e9 18 ff ff ff       	jmp    f0104819 <__umoddi3+0x69>
